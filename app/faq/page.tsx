...
const FAQS = [
  ...
  { q: "Does Landmark offer private or public tours?", a: "We offer private group tours at this time. This means YOU decide who travels on your trip. No other group will interfere with your group. Your itinerary is entirely your own, and your Tour Director will be assigned exclusively to you for the entirety of your trip." },
  ...
  { q: "How are dietary restrictions dealt with?", a: "When your travelers create accounts on our portal system, they will have an opportunity for them to state any and all dietary restrictions. Landmark will collect the dietary restrictions before the trip, and report all restrictions and allergies to designated restaurants. Tour Directors will also ask who specifically has any dietary restrictions on the trip to better direct the servers at sit down meals. When travelers use a meal voucher or cash allocation, however, it will be the students’ responsibility to report their restrictions and allergies." },
  ...
  { q: "Do travelers need extra money for tips and gratuities?", a: "Yes. Gratuities for your Landmark Tour Director, and for any step-on guides used during the trip, are not included in the trip cost. Travelers should budget for these separately. Your Travel Consultant can advise on what to expect for your itinerary." },
