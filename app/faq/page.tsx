...
const FAQS = [
  { q: "What is the trip planning process like?", a: "First, trip organizers contact Landmark to request a private group tour. Our Landmark Specialists reach back to collect information regarding the trip; i.e dates, destination, passenger breakdown. Next, our team personalizes a trip itinerary to match the group’s wants and needs. We provide a trip quote to mimic the inclusions of the itinerary. You have the ability to personalize your trip to include practically anything you want. If you haven’t never traveled before, our Landmark Specialists can provide a number of suggestions on the itinerary for you. This is all free until you agree to proceed with a trip." },
  ...
  { q: "Can I customize a tour?", a: "Absolutely! Our Landmark Specialists are experts in customizing and personalizing a trip itinerary with your desired wants and needs!" },
  ...
  { q: "How are the hotel accommodations situated?", a: "Hotel availability isn’t confirmed until the time of group deposit. During the trip planning process, your Landmark Specialist will provide a tour quote featuring the inclusion of the hotel. You can even request a specific hotel for us to quote, if you wish. By default, we usually situate the students in quads and all parents, teachers and other adult chaperones in singles. Of course, depending on your budget, you can decide what kind of rooms you want to situate everyone in. This is to be discussed with your Landmark Specialist during the trip planning process. Closer to the trip departure, we will request a rooming list from you. You decide which travelers will dorm with who! We do our best to keep everyone on the same floor and/or same wing. We can also request to have female travelers by one wing, and male travelers on the other wing or floor, however this is entirely dependent on the hotel’s design and availability. There is no guarantee the hotel can accommodate all those specific requests. We will do our best to keep you in the loop of what can and cannot be accommodated." },
  { q: "Do Landmark trips offer overnight security?", a: "We can provide you with overnight security if you wish! If not, just let your Landmark Specialist know." },
  { q: "Can the group use public transportation?", a: "Yes! In some cases, this can actually be the most efficient and affordable way to travel! Your Landmark Specialist can help determine when it is best to use public transportation (depending on the destination)." },
  ...
  { q: "Can we stop at a designated souvenir shop?", a: "During the trip planning process, it is important to communicate all desired stops you wish to make while traveling. Whatever is not exclusively noted on the itinerary cannot be assumed to considered because the logistics and timing on the itinerary is meticulously considered. Long story short, yes you can! Just be sure to let your Landmark Specialist know your expectations!" },
  ...
  { q: "What happens after I commit to a trip?", a: "Your Landmark Travel Specialist will send you your personalized trip agreement to confirm the terms and conditions, and payment schedules of the trip. Then, we can share instructions for how your group will register on the portal." },
    ...
    <>
      ...
      <section className="ile-section ile-section--white">
        <div className="ile-container lm-faq-wrap">
          <div className="ile-center lm-narrow"><p className="ile-lead lm-center-lead">Our travel specialists are always ready to answer your questions. Look below to find how to contact us as well as some answers to our most frequently asked questions.</p></div>
