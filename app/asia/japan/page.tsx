  ...
  return (
    <div className="lm-intl">
      <PageHero
        ...
        image="/images/landmark/japan-hero-fuji-pagoda.webp"
      ...
      <DestinationIntro
        ...
        image="/images/landmark/japan-intro-chidorigafuchi.webp"
        wideImage
      ...
      <section className="ile-section ile-section--white" aria-labelledby="japan-handled-h">
        <div className="ile-container">
          <div className="ile-center lm-narrow">
            ...
            <h2 id="japan-handled-h" className="lm-h2-amber">INTERNATIONAL TRAVEL, HANDLED</h2>
      ...
      <section className="ile-section ile-section--cream" aria-labelledby="japan-custom-h">
        <div className="ile-container">
          <div className="ile-center lm-narrow">
            <span className="ile-eyebrow">How it works</span>
            <h2 id="japan-custom-h" className="lm-h2-amber">CUSTOMIZATION MADE SIMPLE</h2>
