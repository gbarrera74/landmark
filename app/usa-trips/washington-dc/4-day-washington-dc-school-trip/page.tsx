  ...
  return (
    <>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "4 Day Washington, DC School Trip", path: "/usa-trips/washington-dc/4-day-washington-dc-school-trip/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/usa-trips/washington-dc/4-day-washington-dc-school-trip/",
