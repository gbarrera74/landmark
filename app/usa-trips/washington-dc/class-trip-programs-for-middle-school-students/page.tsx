...
const DAYS = [
  { title: "Day 1: Arrival & Memorial Tours", acts: ["Travel to Washington, D.C.", "Explore Lincoln, Korean War, and World War II Memorials.", "Enjoy a sit down dinner.", "Check-in to Hotel Accommodations."] },
  { title: "Day 2: United States Capitol & White House", acts: ["Breakfast at the hotel.", "Guided tour of United States Capitol Building.", "Lunch and explore Library of Congress, and National Archives Museum .", "Group Photo at The White House and Lafayette Park.", "Evening memorial visits and dinner."] },
...
const sampleTab = (
  <>
    <p className="lm-itin-note">*Customize and personalize your Class Trip Programs for Middle School Students itinerary with our team.</p>
...
const descriptionTab = (
  <div className="ilp-prose">
    <h2 style={{ marginTop: 0 }}>The Ultimate Washington, D.C. Experience for Middle School Students</h2>
    <p>{DESC_P1}</p>
...
export default function Itin_usa_trips__washington_d_c__class_trip_programs_for_middle_school_students() {
  return (
    <>
      <PageHero
        ...
        image="/images/landmark/dc-white-house-tour-group.webp"
        breadcrumb={[
        { label: "Destinations", href: "/destinations/" },
        { label: "Washington, D.C.", href: "/usa-trips/washington-dc/" },
        { label: "Class Trip Programs for Middle School Students" },
      ]}
      />
          ...
          <aside className="lm-itin-side">
            <div className="lm-summary-card">
              ...
              <dl className="lm-summary-list">
                ...
                <div><dt>Best for</dt><dd>Middle School</dd></div>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Class Trip Programs for Middle School Students", path: "/usa-trips/washington-dc/class-trip-programs-for-middle-school-students/" },
      ])} />
      <JsonLd data={touristTrip({
        name: "Class Trip Programs for Middle School Students",
        description: "A three day educational journey through the nation's capital, blending iconic memorials, the U.S. Capitol, and Smithsonian museums for middle school groups.",
        path: "/usa-trips/washington-dc/class-trip-programs-for-middle-school-students/",
        days: [{ name: "Day 1: Arrival & Memorial Tours", description: "Travel to Washington, D.C.; Explore Lincoln, Korean War, and World War II Memorials.; Enjoy a sit down dinner.; Check-in to Hotel Accommodations." }, { name: "Day 2: United States Capitol & White House", description: "Breakfast at the hotel.; Guided tour of United States Capitol Building.; Lunch and explore Library of Congress, and National Archives Museum .; Group Photo at The White House and Lafayette Park.; Evening memorial visits and dinner." }, { name: "Day 3: Arlington National Cemetery & Departure", description: "Breakfast at the hotel.; Visit US Marine Corps Memorial.; Guided Tour of Arlington National Cemetery (Changing of the Guard, Kennedy gravesite).; Lunch Voucher or boxed sandwich lunch.; Depart for home." }],
      })} />
    </>
  )
}
