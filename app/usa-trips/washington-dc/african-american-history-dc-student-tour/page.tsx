  ...
  return (
    <>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "African American History Washington, DC School Trip", path: "/usa-trips/washington-dc/african-american-history-dc-student-tour/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/usa-trips/washington-dc/african-american-history-dc-student-tour/",
