...
const TRIPS = [
  ...
  { title: '8th Grade Washington, DC Trip Itinerary', duration: '3 Day / 2 Night', img: '/images/landmark/dc-washington-monument-group.jpg', href: '/usa-trips/washington-dc/8th-grade-washington-dc-trip-itinerary/' },
  { title: 'HBCU Campus Tours', duration: '7 Day / 6 Night', img: '/images/landmark/dc-hbcu-howard-group.jpg', href: '/usa-trips/washington-dc/hbcu-campus-tours/' },
  ...
  { title: 'Civics Focused Washington, DC School Trip', duration: '3 Day / 2 Night', img: '/images/landmark/dc-jefferson-memorial-website.jpg', href: '/usa-trips/washington-dc/washington-dc-civics-student-tour/' },
  ...
  { title: 'African American History Washington, DC School Trip', duration: '3 Day / 2 Night', img: '/images/landmark/dc-nmaahc-group.jpg', href: '/usa-trips/washington-dc/african-american-history-dc-student-tour/' },
  ...
  { title: 'Presidential Inauguration 2029 School Trip', duration: '4 Day / 3 Night', img: '/images/landmark/dc-white-house-solo.jpg', href: '/usa-trips/washington-dc/2029-presidential-inauguration-class-trips/' },
  { title: '5 Day Washington, DC School Trip', duration: '5 Day / 4 Night', img: '/images/landmark/dc-5day-smithsonian-zoo.jpg', href: '/usa-trips/washington-dc/5-day-washington-dc-school-trip/' },
]
...
export default function WashingtonDC() {
  return (
    <>
      ...
      <PageFaq items={PAGE_FAQS['/usa-trips/washington-dc/']} id="dc-faq" heading="Washington, D.C. school trips: common questions" tone="white" />
      ...
      <JsonLd data={destinationGraph({ name: "Washington, D.C.", description: `Customizable Washington, D.C. field trips and student tours, the National Mall, Smithsonian museums, the U.S. Capitol, Arlington, and more. Safe, guided, and built around your curriculum.`, path: "/usa-trips/washington-dc/", trips: TRIPS.map((t) => ({ name: t.title, path: t.href })) })} />
    </>
  )
}
