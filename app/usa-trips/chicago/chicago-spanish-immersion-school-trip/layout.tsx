...
export const metadata: Metadata = {
  ...
  description:
    "A two-day Spanish immersion adventure through Chicago's vibrant Latino neighborhoods, cultural landmarks, and interactive language experiences for student groups. A customizable 2 Day / 1 Night Landmark educational itinerary.",
