...
const DAYS = [
  { title: "Day 1: Arrival & Memorial Tours", acts: ["Travel to Washington, D.C.", "Explore Lincoln, Korean War, and World War II Memorials", "Group sit-down dinner", "Check-in to Hotel Accommodations with on-site security"] },
  { title: "Day 2: United States Capitol & White House", acts: ["Breakfast at the hotel", "Guided tour of United States Capitol Building", "Lunch and explore Smithsonian Museums of choice", "Group Photo at The White House and Lafayette Park", "Evening memorial visits and dinner"] },
  { title: "Day 3: Arlington National Cemetery & Smithsonian Museum Exploration", acts: ["Breakfast at the hotel", "Visit US Marine Corps Memorial", "Guided Tour of Arlington National Cemetery (Changing of the Guard, Kennedy gravesite)", "Lunch Voucher or boxed sandwich lunch", "Visiting the Smithsonian National Museums, the International Spy Museum, the United States Holocaust Museum and many more", "Enjoy a sit-down dinner and evening activity"] },
  { title: "Day 4: Mount Vernon & Departure", acts: ["Breakfast at the hotel", "Tour George Washington’s Mount Vernon Estate (mansion, gardens, and exhibits)", "Lunch at Mount Vernon’s food court", "Depart for Home"] },
]
...
const descriptionTab = (
  <div className="ilp-prose">
    <h2 style={{ marginTop: 0 }}>Explore the Ultimate 4 Day Washington, D.C. School Trip Itinerary</h2>
    <p>{DESC_P1}</p>
...
export default function Itin_usa_trips__washington_d_c__4_day_washington_dc_school_trip() {
  return (
    <>
      <PageHero
        ...
        { label: "4 Day Washington, DC School Trip" },
      ]}
      />
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "4 Day Washington, DC School Trip", path: "/usa-trips/washington-d-c/4-day-washington-dc-school-trip/" },
      ])} />
      <JsonLd data={touristTrip({
        name: "4 Day Washington, DC School Trip",
        description: "Explore the nation's capital over four days of monuments, museums, and hands-on lessons in American history and government.",
        path: "/usa-trips/washington-d-c/4-day-washington-dc-school-trip/",
        days: [{ name: "Day 1: Arrival & Memorial Tours", description: "Travel to Washington, D.C.; Explore Lincoln, Korean War, and World War II Memorials; Group sit-down dinner; Check-in to Hotel Accommodations with on-site security" }, { name: "Day 2: United States Capitol & White House", description: "Breakfast at the hotel; Guided tour of United States Capitol Building; Lunch and explore Smithsonian Museums of choice; Group Photo at The White House and Lafayette Park; Evening memorial visits and dinner" }, { name: "Day 3: Arlington National Cemetery & Smithsonian Museum Exploration", description: "Breakfast at the hotel; Visit US Marine Corps Memorial; Guided Tour of Arlington National Cemetery (Changing of the Guard, Kennedy gravesite); Lunch Voucher or boxed sandwich lunch; Visiting the Smithsonian National Museums, the International Spy Museum, the United States Holocaust Museum and many more; Enjoy a sit-down dinner and evening activity" }, { name: "Day 4: Mount Vernon & Departure", description: "Breakfast at the hotel; Tour George Washington’s Mount Vernon Estate (mansion, gardens, and exhibits); Lunch at Mount Vernon’s food court; Depart for Home" }],
      })} />
    </>
  )
}
