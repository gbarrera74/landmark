...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/usa-trips/washington-d-c/2029-presidential-inauguration-class-trips/" },
  openGraph: { title: "Presidential Inauguration 2029 School Trip | Landmark Educational Tours", description: "Witness the historic 2029 Presidential Inauguration and explore Washington D.C. landmarks on this four day student journey through American democracy.", url: "/usa-trips/washington-d-c/2029-presidential-inauguration-class-trips/" },
}
