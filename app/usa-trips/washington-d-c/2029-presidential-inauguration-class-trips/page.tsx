  ...
  return (
    <>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Presidential Inauguration 2029 School Trip", path: "/usa-trips/washington-d-c/2029-presidential-inauguration-class-trips/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/usa-trips/washington-d-c/2029-presidential-inauguration-class-trips/",
