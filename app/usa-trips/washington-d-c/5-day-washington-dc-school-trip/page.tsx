  ...
  return (
    <>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "5 Day Washington, DC School Trip", path: "/usa-trips/washington-d-c/5-day-washington-dc-school-trip/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/usa-trips/washington-d-c/5-day-washington-dc-school-trip/",
