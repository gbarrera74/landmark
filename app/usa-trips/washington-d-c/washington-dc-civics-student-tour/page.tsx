  ...
  return (
    <>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Civics Focused Washington, DC School Trip", path: "/usa-trips/washington-d-c/washington-dc-civics-student-tour/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/usa-trips/washington-d-c/washington-dc-civics-student-tour/",
