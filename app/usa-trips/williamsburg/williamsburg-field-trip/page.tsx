...
const RELATED = [
  { title: "Williamsburg School Trip", img: "/images/landmark/williamsburg-1.jpg", href: "/usa-trips/williamsburg/williamsburg-school-trip/" },
]
  ...
  return (
    <>
      <PageHero
        ...
        image="/images/landmark/williamsburg-field-jamestown-group.jpg"
        breadcrumb={[
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Williamsburg Field Trip", path: "/usa-trips/williamsburg/williamsburg-field-trip/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/usa-trips/williamsburg/williamsburg-field-trip/",
        days: [],
      })} />
    </>
  )
