  ...
  return (
    <>
      <PageHero
        ...
        image="/images/landmark/philly-historic-independence-hall.webp"
        breadcrumb={[
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Historic Philadelphia School Trip", path: "/usa-trips/philadelphia/historic-philadelphia-school-trip/" },
      ])} />
