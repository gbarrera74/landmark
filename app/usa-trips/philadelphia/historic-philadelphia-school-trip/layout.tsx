...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Historic Philadelphia School Trip | Landmark Educational Tours", description: "Trace the birthplace of American democracy across three days of hands-on history, iconic landmarks, and world-class museums.", url: "/usa-trips/philadelphia/historic-philadelphia-school-trip/" },
}
