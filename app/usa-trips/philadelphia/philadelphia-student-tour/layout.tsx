...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Philadelphia Student Tour | Landmark Educational Tours", description: "Spend two days exploring the birthplace of American democracy, from Independence Hall and the Liberty Bell to the historic streets of Old City.", url: "/usa-trips/philadelphia/philadelphia-student-tour/" },
}
