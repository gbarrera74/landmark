...
const DAYS = [
  ...
  { title: "Day 2: Freedom Walking Tour & Fenway Park", acts: ["Arrival in Boston", "Breakfast Allocation", "Tour Director Led Walking Tour of the Freedom Trail", "Grab n’ Go Lunch at Quincy Market", "Guided Tour of Fenway Park", "Visit the Museum of Science", "Group sit-down dinner", "Return to Hotel Accommodations"] },
