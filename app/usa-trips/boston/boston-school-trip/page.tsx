...
const DAYS = [
  { title: "Day 1: Arrival & New England Aquarium", acts: ["Travel to Boston, MA", "Visit the New England Aquarium", "Group sit-down dinner", "Check-in to Hotel Accommodations"] },
  { title: "Day 2: USS Constitution & Departure", acts: ["Hotel Breakfast", "Visit USS Constitution", "Visit the USS Constitution Museum or Plimoth Patuxet", "Boxed Sandwich Lunch", "Depart for Home"] },
]
...
const sampleTab = (
  <>
    <p className="lm-itin-note">*Customize and personalize your Boston School Trip itinerary with our team.</p>
...
const descriptionTab = (
  <div className="ilp-prose">
    <h2 style={{ marginTop: 0 }}>The Ultimate Boston School Trip They’ll Never Forget</h2>
    <p>{DESC_P1}</p>
...
export default function Itin_usa_trips__boston__boston_school_trip() {
  return (
    <>
      <PageHero
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Boston School Trip", path: "/usa-trips/boston/boston-school-trip/" },
      ])} />
      <JsonLd data={touristTrip({
        name: "Boston School Trip",
        description: "Walk the Freedom Trail, tour the USS Constitution, and bring the American Revolution to life for your students.",
        path: "/usa-trips/boston/boston-school-trip/",
        days: [{ name: "Day 1: Arrival & New England Aquarium", description: "Travel to Boston, MA; Visit the New England Aquarium; Group sit-down dinner; Check-in to Hotel Accommodations" }, { name: "Day 2: USS Constitution & Departure", description: "Hotel Breakfast; Visit USS Constitution; Visit the USS Constitution Museum or Plimoth Patuxet; Boxed Sandwich Lunch; Depart for Home" }],
      })} />
    </>
  )
}
