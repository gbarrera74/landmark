...
const DAYS = [
  { title: "Day 1: Arrival & Freedom Trail Walking Tour", acts: ["Travel to Boston, MA", "Freedom Trail Walking Tour", "Visit Boston Tea Party Ships & Museum", "Group sit-down dinner in Little Italy", "Check-in to Hotel Accommodations"] },
  { title: "Day 2: Salem Witch Museum & Ghost Tour", acts: ["Hotel Breakfast", "Depart to Salem, MA", "Visit the Salem Witch Museum", "Walking Tour of Salem Historic Sites", "Lunch Included", "Visit the Peabody Essex Museum", "Visit the Salem Maritime Site", "Depart for Boston", "Dinner at Time Out Market", "Ghost Tour", "Return to Hotel Accommodations"] },
...
const DESC_P1 = "Embark on an exciting four-day educational adventure exploring the historic city of Boston and the enchanting town of Salem! Walk the Freedom Trail and visit landmarks like the Boston Tea Party Ships and Museum to uncover Boston’s role in shaping America’s history. Then, journey to Salem to delve into its fascinating past, from the infamous Salem Witch Trials at the Salem Witch Museum to the charming streets steeped in maritime history. This immersive, hands-on learning experience blends the revolutionary spirit of Boston with the intriguing legacy of Salem, leaving students inspired and engaged with history and culture."
const DESC_P2 = "Our Boston and Salem school trips offer students a unique opportunity to explore two of New England’s most influential destinations in a single educational experience. By combining Boston’s revolutionary history with Salem’s captivating cultural heritage, students gain a broader understanding of the events, people, and ideas that shaped America. Landmark’s educational trips to Boston and Salem encourage critical thinking, historical inquiry, and meaningful engagement through immersive site visits and memorable experiences that bring classroom lessons to life."

const sampleTab = (
  <>
    <p className="lm-itin-note">*Customize and personalize your Boston &amp; Salem School Trip itinerary with our team.</p>
...
const descriptionTab = (
  <div className="ilp-prose">
    <h2 style={{ marginTop: 0 }}>Explore the Ultimate Boston and Salem School Trip Itinerary</h2>
    <p>{DESC_P1}</p>
    <p>{DESC_P2}</p>
...
export default function Itin_usa_trips__boston__boston_and_salem_school_trip() {
  return (
    <>
      <PageHero
        ...
        { label: "Boston & Salem School Trip" },
      ]}
      />
          ...
          <aside className="lm-itin-side">
            <div className="lm-summary-card">
              ...
              <dl className="lm-summary-list">
                ...
                <div><dt>Destination</dt><dd>Boston &amp; Salem, MA</dd></div>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Boston & Salem School Trip", path: "/usa-trips/boston/boston-and-salem-school-trip/" },
      ])} />
      <JsonLd data={touristTrip({
        name: "Boston & Salem School Trip",
        description: "Blend Boston's revolutionary landmarks with Salem's haunted history on a four day journey students will remember.",
        path: "/usa-trips/boston/boston-and-salem-school-trip/",
        days: [{ name: "Day 1: Arrival & Freedom Trail Walking Tour", description: "Travel to Boston, MA; Freedom Trail Walking Tour; Visit Boston Tea Party Ships & Museum; Group sit-down dinner in Little Italy; Check-in to Hotel Accommodations" }, { name: "Day 2: Salem Witch Museum & Ghost Tour", description: "Hotel Breakfast; Depart to Salem, MA; Visit the Salem Witch Museum; Walking Tour of Salem Historic Sites; Lunch Included; Visit the Peabody Essex Museum; Visit the Salem Maritime Site; Depart for Boston; Dinner at Time Out Market; Ghost Tour; Return to Hotel Accommodations" }, { name: "Day 3: Harvard University & Fenway Park", description: "Hotel Breakfast; Visit the Museum of Science; Lunch in Cambridge, MA; Guided Tour of Harvard University; Visit the Isabella Stewart Gardner Museum; Guided Tour of Fenway Park; Dinner and Games at Level 99; Return to Hotel Accommodations" }, { name: "Day 4: Duck Boat Tour & Departure", description: "Hotel Breakfast; Guided Duck Boat Tour; Visit the USS Constitution Museum; Lunch at Faneuil Hall; Depart for Home" }],
      })} />
    </>
  )
}
