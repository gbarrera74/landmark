...
export const metadata: Metadata = {
  title: { absolute: "Historic Boston | Landmark Educational Tours" },
  description:
    "Walk the Freedom Trail and explore revolutionary landmarks on a three day Boston tour built for student groups. A customizable 3 Day / 2 Night Landmark educational itinerary.",
