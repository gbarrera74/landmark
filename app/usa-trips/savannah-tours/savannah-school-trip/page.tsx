...
const WHY = [
  { label: "Engaging Learning", text: "Discover history through guided tours and interactive educational experiences." },
  { label: "Historic Locations", text: "Explore preserved sites that showcase important moments and stories from the past." },
  { label: "Classroom Connections", text: "Link academic concepts to real-world places and events." },
  { label: "Lasting Impact", text: "Create educational experiences that students remember long after the trip ends." },
]
...
const RELATED = [
  { title: "Savannah Field Trip", img: "/images/landmark/savannah-1.jpg", href: "/usa-trips/savannah-tours/savannah-field-trip/" },
]

const DESC_P1 = "Begin an engaging educational journey to Savannah, GA, thoughtfully designed for school groups looking to bring learning beyond the classroom. This immersive school trip introduces students to a city rich in history and culture through guided experiences and visits to preserved sites that tell powerful stories of the past. Interactive learning opportunities help students connect academic lessons to real locations, making history feel relevant and engaging. By blending exploration with educational enrichment, a Savannah school trip encourages curiosity, critical thinking, and a deeper understanding of history, while creating meaningful and memorable experiences in one of the South’s most historic cities."

const sampleTab = (
  <>
    <div className="ilp-infocard">
      <h3>A detailed day-by-day sample is on the way.</h3>
      <p style={{ color: 'var(--lm-ink-muted)', fontSize: 15, lineHeight: 1.7 }}>Every Landmark trip is fully customized to your group, so we build your ideal Savannah School Trip itinerary together around your dates, grade level, and goals. Reach out and our Travel Consultants will map out the perfect schedule.</p>
...
const descriptionTab = (
  <div className="ilp-prose">
    <h2 style={{ marginTop: 0 }}>Savannah School Trip Experience for Students</h2>
    <p>{DESC_P1}</p>
...
export default function Itin_usa_trips__savannah_tours__savannah_school_trip() {
  return (
    <>
      <PageHero
        ...
        image="/images/landmark/savannah-2.jpg"
        breadcrumb={[
        { label: "Destinations", href: "/destinations/" },
        { label: "Savannah", href: "/usa-trips/savannah-tours/" },
        { label: "Savannah School Trip" },
      ]}
      />
        ...
        <div className="ile-container lm-itin-grid">
          ...
          <aside className="lm-itin-side">
            <div className="lm-summary-card">
              ...
              <Link href="/usa-trips/savannah-tours/" className="lm-summary-link">More Savannah packages {ArrowR}</Link>
            </div>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Savannah School Trip", path: "/usa-trips/savannah-tours/savannah-school-trip/" },
      ])} />
      <JsonLd data={touristTrip({
        name: "Savannah School Trip",
        description: "Bring learning to life with a customizable Savannah journey through preserved historic sites and interactive experiences built for student groups.",
        path: "/usa-trips/savannah-tours/savannah-school-trip/",
        days: [],
      })} />
    </>
  )
