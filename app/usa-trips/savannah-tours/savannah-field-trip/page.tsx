...
const RELATED = [
  { title: "Savannah School Trip", img: "/images/landmark/savannah-2.jpg", href: "/usa-trips/savannah-tours/savannah-school-trip/" },
]
  ...
  return (
    <>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Savannah Field Trip", path: "/usa-trips/savannah-tours/savannah-field-trip/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/usa-trips/savannah-tours/savannah-field-trip/",
        days: [],
      })} />
    </>
  )
