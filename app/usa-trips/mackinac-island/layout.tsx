...
export const metadata: Metadata = {
  title: { absolute: "Educational Field Trips in Mackinac Island | Landmark Educational Tours" },
  description:
  ...
  alternates: { canonical: "/usa-trips/mackinac-island/" },
  openGraph: {
