...
const RELATED = [
  { title: "Mackinac Island Field Trip", img: "/images/landmark/mackinac-2.jpg", href: "/usa-trips/mackinac-island/mackinac-island-field-trip/" },
]
  ...
  return (
    <>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Mackinac Island School Trip", path: "/usa-trips/mackinac-island/mackinac-island-school-trip/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/usa-trips/mackinac-island/mackinac-island-school-trip/",
        days: [],
      })} />
    </>
  )
