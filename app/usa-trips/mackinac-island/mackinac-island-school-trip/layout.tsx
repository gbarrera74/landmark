...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Mackinac Island School Trip | Landmark Educational Tours", description: "Explore historic Mackinac Island on a customizable educational field trip that connects students to real places and living traditions.", url: "/usa-trips/mackinac-island/mackinac-island-school-trip/" },
}
