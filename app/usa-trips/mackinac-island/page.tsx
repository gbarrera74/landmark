...
const TRIPS = [
  { title: "Mackinac Island School Trip", duration: "2 Day / 1 Night", img: '/images/landmark/mackinac-school-tipton-overlook.webp', href: "/usa-trips/mackinac-island/mackinac-island-school-trip/" },
  { title: "Mackinac Island Field Trip", duration: "2 Day / 1 Night", img: '/images/landmark/mackinac-field-lake-huron.webp', href: "/usa-trips/mackinac-island/mackinac-island-field-trip/" },
]
...
export default function MackinacIsland() {
  return (
    <>
      ...
      <JsonLd data={destinationGraph({ name: "Mackinac Island", description: `Customizable Mackinac Island field trips and student tours: safe, guided, and built around your curriculum. Plan your Mackinac Island educational trip with Landmark Educational Tours.`, path: "/usa-trips/mackinac-island/", trips: TRIPS.map((t) => ({ name: t.title, path: t.href })) })} />
    </>
  )
}
