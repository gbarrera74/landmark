...
export const metadata: Metadata = {
  ...
  openGraph: { title: "3 Day New Orleans School Trip | Landmark Educational Tours", description: "A three day journey through New Orleans jazz, cemeteries, and Creole culture built for student groups of every grade.", url: "/usa-trips/new-orleans/3-day-new-orleans-school-trip/" },
}
