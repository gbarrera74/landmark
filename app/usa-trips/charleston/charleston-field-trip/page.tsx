...
const RELATED = [
  { title: "Charleston School Trip", img: "/images/landmark/charleston-2.webp", href: "/usa-trips/charleston/charleston-school-trip/" },
]
  ...
  return (
    <>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Charleston Field Trip", path: "/usa-trips/charleston/charleston-field-trip/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/usa-trips/charleston/charleston-field-trip/",
        days: [],
      })} />
    </>
  )
