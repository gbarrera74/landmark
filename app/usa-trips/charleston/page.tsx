...
const TRIPS = [
  { title: "Charleston Field Trip", duration: "3 Day / 2 Night", img: '/images/landmark/charleston-field-rainbow-row.webp', href: "/usa-trips/charleston/charleston-field-trip/" },
  { title: "Charleston School Trip", duration: "2 Day / 1 Night", img: '/images/landmark/charleston-school-pineapple-fountain.webp', href: "/usa-trips/charleston/charleston-school-trip/" },
]
...
export default function Charleston() {
  return (
    <>
      ...
      <JsonLd data={destinationGraph({ name: "Charleston", description: `Customizable Charleston field trips and student tours: safe, guided, and built around your curriculum. Plan your Charleston educational trip with Landmark Educational Tours.`, path: "/usa-trips/charleston/", trips: TRIPS.map((t) => ({ name: t.title, path: t.href })) })} />
    </>
  )
}
