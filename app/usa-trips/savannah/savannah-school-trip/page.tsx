...
const RELATED = [
  { title: "Savannah Field Trip", img: "/images/landmark/savannah-1.webp", href: "/usa-trips/savannah/savannah-field-trip/" },
]
  ...
  return (
    <>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Savannah School Trip", path: "/usa-trips/savannah/savannah-school-trip/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/usa-trips/savannah/savannah-school-trip/",
        days: [],
      })} />
    </>
  )
