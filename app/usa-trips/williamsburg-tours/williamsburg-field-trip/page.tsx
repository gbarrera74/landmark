...
const WHY = [
  { label: "Interactive Learning", text: "Experience history through demonstrations, activities, and guided programs." },
  { label: "Historic Environments", text: "Explore authentic locations that reflect daily life in early America." },
  { label: "Curriculum Support", text: "Reinforce social studies concepts through real-world learning." },
  { label: "Memorable Experiences", text: "Create lasting memories while learning beyond the classroom." },
]
...
const RELATED = [
  { title: "Williamsburg School Trip", img: "/images/landmark/williamsburg-1.jpg", href: "/usa-trips/williamsburg-tours/williamsburg-school-trip/" },
]

const DESC_P1 = "Set out on a memorable educational journey to Williamsburg! This immersive field trip invites students to step into early American life through interactive programs, guided explorations, and thoughtfully preserved historic settings. As students walk through historic streets, observe traditional trades, and participate in hands-on learning experiences, history becomes engaging, personal, and easy to understand. With strong connections to classroom learning, a Williamsburg field trip blends education and discovery, helping students better understand how people lived, worked, and made decisions during America’s formative years."

const sampleTab = (
  <>
    <div className="ilp-infocard">
      <h3>A detailed day-by-day sample is on the way.</h3>
      <p style={{ color: 'var(--lm-ink-muted)', fontSize: 15, lineHeight: 1.7 }}>Every Landmark trip is fully customized to your group, so we build your ideal Williamsburg Field Trip itinerary together around your dates, grade level, and goals. Reach out and our Travel Consultants will map out the perfect schedule.</p>
...
const descriptionTab = (
  <div className="ilp-prose">
    <h2 style={{ marginTop: 0 }}>Williamsburg Field Trip Experience for Students</h2>
    <p>{DESC_P1}</p>
...
export default function Itin_usa_trips__williamsburg_tours__williamsburg_field_trip() {
  return (
    <>
      <PageHero
        ...
        { label: "Williamsburg", href: "/usa-trips/williamsburg-tours/" },
        { label: "Williamsburg Field Trip" },
      ]}
      />
        ...
        <div className="ile-container lm-itin-grid">
          ...
          <aside className="lm-itin-side">
            <div className="lm-summary-card">
              ...
              <Link href="/usa-trips/williamsburg-tours/" className="lm-summary-link">More Williamsburg packages {ArrowR}</Link>
            </div>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Williamsburg", path: "/usa-trips/williamsburg-tours/" },
        { name: "Williamsburg Field Trip", path: "/usa-trips/williamsburg-tours/williamsburg-field-trip/" },
      ])} />
      <JsonLd data={touristTrip({
        name: "Williamsburg Field Trip",
        description: "Students step into early American life in Williamsburg through interactive programs, guided explorations, and thoughtfully preserved historic settings.",
        path: "/usa-trips/williamsburg-tours/williamsburg-field-trip/",
        days: [],
      })} />
    </>
  )
