...
const RELATED = [
  { title: "Williamsburg Field Trip", img: "/images/landmark/williamsburg-2.jpg", href: "/usa-trips/williamsburg-tours/williamsburg-field-trip/" },
]
  ...
  return (
    <>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Williamsburg School Trip", path: "/usa-trips/williamsburg-tours/williamsburg-school-trip/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/usa-trips/williamsburg-tours/williamsburg-school-trip/",
        days: [],
      })} />
    </>
  )
