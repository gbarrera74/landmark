...
const RELATED = [
  { title: "Charleston Field Trip", img: "/images/landmark/charleston-1.jpg", href: "/usa-trips/charleston-sc/charleston-field-trip/" },
]
  ...
  return (
    <>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Charleston School Trip", path: "/usa-trips/charleston-sc/charleston-school-trip/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/usa-trips/charleston-sc/charleston-school-trip/",
        days: [],
      })} />
    </>
  )
