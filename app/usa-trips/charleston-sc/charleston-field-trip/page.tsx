...
const WHY = [
  { label: "Interactive Learning", text: "Experience history and culture through guided tours, museums, and engaging activities." },
  { label: "Historic Landmarks", text: "Visit iconic sites that showcase Charleston’s role in American history." },
  { label: "Cultural Connections", text: "Explore traditions, architecture, and stories unique to the Lowcountry." },
  { label: "Lasting Memories", text: "Create impactful experiences while learning in one of America’s most historic cities." },
]
...
const RELATED = [
  { title: "Charleston School Trip", img: "/images/landmark/charleston-2.jpg", href: "/usa-trips/charleston-sc/charleston-school-trip/" },
]

const DESC_P1 = "Set out on an unforgettable educational journey through Charleston, South Carolina, thoughtfully designed for school groups! Students will step into America’s past while exploring cobblestone streets, historic homes, waterfront landmarks, and engaging museums that bring history, culture, and coastal life to life. From hands-on learning experiences to guided explorations of Charleston’s role in American history, this field trip blends education and discovery in a way that feels both meaningful and exciting. With its rich heritage, preserved architecture, and unique coastal setting, Charleston offers students an immersive learning environment that extends far beyond the classroom, encouraging curiosity, reflection, and a deeper connection to the stories that shaped the nation."
const DESC_P2 = "As one of the most enriching destinations in the Southeast, Charleston provides exceptional opportunities for experiential learning across multiple subjects, including American history, civics, architecture, and cultural studies. Our educational tours in Charleston, South Carolina, engage students through meaningful interactions with the city’s historic sites and vibrant communities. Whether you’re planning immersive school trips to Charleston for middle school, high school, or student organizations, Landmark Educational Tours creates customized experiences that inspire curiosity, encourage critical thinking, and help students connect classroom lessons to real-world places and events."

const sampleTab = (
  <>
    <div className="ilp-infocard">
      <h3>A detailed day-by-day sample is on the way.</h3>
      <p style={{ color: 'var(--lm-ink-muted)', fontSize: 15, lineHeight: 1.7 }}>Every Landmark trip is fully customized to your group, so we build your ideal Charleston Field Trip itinerary together around your dates, grade level, and goals. Reach out and our Travel Consultants will map out the perfect schedule.</p>
...
const descriptionTab = (
  <div className="ilp-prose">
    <h2 style={{ marginTop: 0 }}>Charleston Field Trip Experience for Students</h2>
    <p>{DESC_P1}</p>
    <p>{DESC_P2}</p>
...
export default function Itin_usa_trips__charleston_sc__charleston_field_trip() {
  return (
    <>
      <PageHero
        ...
        { label: "Charleston", href: "/usa-trips/charleston-sc/" },
        { label: "Charleston Field Trip" },
      ]}
      />
          ...
          <aside className="lm-itin-side">
            <div className="lm-summary-card">
              ...
              <dl className="lm-summary-list">
                ...
                <div><dt>Best for</dt><dd>Middle &amp; High School</dd></div>
                <div><dt>Style</dt><dd>Private, fully customizable</dd></div>
              </dl>
              <Link href="/get-a-quote/" className="ile-btn ile-btn--primary lm-summary-cta">Get a Quote</Link>
              <Link href="/usa-trips/charleston-sc/" className="lm-summary-link">More Charleston packages {ArrowR}</Link>
            </div>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Charleston", path: "/usa-trips/charleston-sc/" },
        { name: "Charleston Field Trip", path: "/usa-trips/charleston-sc/charleston-field-trip/" },
      ])} />
      <JsonLd data={touristTrip({
        name: "Charleston Field Trip",
        description: "Students explore Charleston's cobblestone streets, historic homes, and waterfront landmarks on an immersive educational journey through the Lowcountry.",
        path: "/usa-trips/charleston-sc/charleston-field-trip/",
        days: [],
      })} />
    </>
  )
