  ...
  return (
    <>
      <PageHero
        ...
        { label: "New Mexico", href: "/usa-trips/new-mexico-tours/" },
        ...
        <div className="ile-container lm-itin-grid">
          ...
          <aside className="lm-itin-side">
            <div className="lm-summary-card">
              ...
              <Link href="/usa-trips/new-mexico-tours/" className="lm-summary-link">More New Mexico packages {ArrowR}</Link>
            </div>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "New Mexico School Trip", path: "/usa-trips/new-mexico-tours/new-mexico-school-trip/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/usa-trips/new-mexico-tours/new-mexico-school-trip/",
