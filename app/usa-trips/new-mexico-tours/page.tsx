...
const TRIPS = [
  { title: "New Mexico School Trip", duration: "4 Day / 3 Night", img: '/images/landmark/new-mexico-1.jpg', href: "/usa-trips/new-mexico-tours/new-mexico-school-trip/" },
]
  ...
  return (
    <>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "New Mexico", path: "/usa-trips/new-mexico-tours/" },
      ])} />
    </>
  )
}
