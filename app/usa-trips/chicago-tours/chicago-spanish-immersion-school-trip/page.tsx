...
const RELATED = [
  { title: "Chicago Student Tour", img: "/images/landmark/chicago-1.jpg", href: "/usa-trips/chicago-tours/chicago-student-tour/" },
  ...
  return (
    <>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Chicago Spanish Immersion School Trip", path: "/usa-trips/chicago-tours/chicago-spanish-immersion-school-trip/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/usa-trips/chicago-tours/chicago-spanish-immersion-school-trip/",
