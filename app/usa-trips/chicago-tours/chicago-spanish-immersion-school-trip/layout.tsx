...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/usa-trips/chicago-tours/chicago-spanish-immersion-school-trip/" },
  openGraph: { title: "Chicago Spanish Immersion School Trip | Landmark Educational Tours", description: "A two-day Spanish immersion adventure through Chicago's vibrant Latino neighborhoods, cultural landmarks, and interactive language experiences for student groups.", url: "/usa-trips/chicago-tours/chicago-spanish-immersion-school-trip/" },
}
