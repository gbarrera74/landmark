...
const RELATED = [
  { title: "Los Angeles School Trip", img: "/images/landmark/los-angeles-1.jpg", href: "/usa-trips/los-angeles-tours/los-angeles-school-trip/" },
]
  ...
  return (
    <>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Los Angeles Field Trip", path: "/usa-trips/los-angeles-tours/los-angeles-field-trip/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/usa-trips/los-angeles-tours/los-angeles-field-trip/",
