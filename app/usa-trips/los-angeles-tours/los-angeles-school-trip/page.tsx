...
const RELATED = [
  { title: "Los Angeles Field Trip", img: "/images/landmark/los-angeles-2.jpg", href: "/usa-trips/los-angeles-tours/los-angeles-field-trip/" },
]
  ...
  return (
    <>
      <PageHero
        ...
        { label: "Los Angeles", href: "/usa-trips/los-angeles-tours/" },
        ...
        <div className="ile-container lm-itin-grid">
          ...
          <aside className="lm-itin-side">
            <div className="lm-summary-card">
              ...
              <Link href="/usa-trips/los-angeles-tours/" className="lm-summary-link">More Los Angeles packages {ArrowR}</Link>
            </div>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Los Angeles", path: "/usa-trips/los-angeles-tours/" },
        { name: "Los Angeles School Trip", path: "/usa-trips/los-angeles-tours/los-angeles-school-trip/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/usa-trips/los-angeles-tours/los-angeles-school-trip/",
