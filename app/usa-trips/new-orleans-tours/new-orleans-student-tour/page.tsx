...
const RELATED = [
  { title: "3 Day New Orleans School Trip", img: "/images/landmark/new-orleans-2.jpg", href: "/usa-trips/new-orleans-tours/3-day-new-orleans-school-trip/" },
...
const sampleTab = (
  <>
    <p className="lm-itin-note">*Customize and personalize your New Orleans Student Tour itinerary with our team.</p>
...
const descriptionTab = (
  <div className="ilp-prose">
    <h2 style={{ marginTop: 0 }}>Explore the Ultimate New Orleans New Orleans Student Tour Itinerary</h2>
    <p>{DESC_P1}</p>
...
export default function Itin_usa_trips__new_orleans_tours__new_orleans_student_tour() {
  return (
    <>
      <PageHero
        ...
        { label: "New Orleans Student Tour" },
      ]}
      />
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "New Orleans Student Tour", path: "/usa-trips/new-orleans-tours/new-orleans-student-tour/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/usa-trips/new-orleans-tours/new-orleans-student-tour/",
