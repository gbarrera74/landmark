...
const RELATED = [
  { title: "Intro to San Antonio Tour", img: "/images/landmark/san-antonio-1.jpg", href: "/usa-trips/san-antonio-tours/intro-to-san-antonio-tour/" },
  ...
  return (
    <>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "3 Day San Antonio School Trip", path: "/usa-trips/san-antonio-tours/3-day-san-antonio-school-trip/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/usa-trips/san-antonio-tours/3-day-san-antonio-school-trip/",
