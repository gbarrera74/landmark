...
const DESC_P1 = "Embark on an exciting two-day educational adventure in Atlanta, designed to inspire students of all grade levels! Dive into the city’s rich history and culture with visits to the Martin Luther King Jr. National Historic Site, the National Center for Civil and Human Rights, and the World of Coca-Cola. From exploring Atlanta’s pivotal role in the Civil Rights Movement to experiencing interactive exhibits and vibrant attractions, this immersive, hands-on trip promises to leave students inspired and excited about history, innovation, and culture."

const sampleTab = (
  <>
    <p className="lm-itin-note">*Customize and personalize your 2 Day Atlanta School Trip itinerary with our team.</p>
...
const descriptionTab = (
  <div className="ilp-prose">
    <h2 style={{ marginTop: 0 }}>Explore the Ultimate 2 Day Atlanta School Trip Itinerary</h2>
    <p>{DESC_P1}</p>
...
export default function Itin_usa_trips__atlanta__2_day_atlanta_school_trip() {
  return (
    <>
      <PageHero
        ...
        { label: "2 Day Atlanta School Trip" },
      ]}
      />
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "2 Day Atlanta School Trip", path: "/usa-trips/atlanta/2-day-atlanta-school-trip/" },
      ])} />
