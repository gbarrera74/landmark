  ...
  return (
    <>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "4 Day New York City School Trip", path: "/usa-trips/new-york-city/4-day-new-york-city-school-trip/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/usa-trips/new-york-city/4-day-new-york-city-school-trip/",
