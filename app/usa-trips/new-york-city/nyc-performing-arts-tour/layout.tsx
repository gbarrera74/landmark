...
export const metadata: Metadata = {
  ...
  openGraph: { title: "NYC Performing Arts Tour | Landmark Educational Tours", description: "Immerse your student performers in the magic of Broadway with backstage access, hands-on workshops, and a world-class show in the heart of Times Square.", url: "/usa-trips/new-york-city/nyc-performing-arts-tour/" },
}
