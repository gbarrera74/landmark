...
export const metadata: Metadata = {
  ...
  openGraph: { title: "YMCA Summer Camp | Landmark Educational Tours", description: "A three day New York City summer camp adventure packed with iconic landmarks, hands on learning, and team building for student groups.", url: "/usa-trips/new-york-city/ymca-summer-camp/" },
}
