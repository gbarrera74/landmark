  ...
  return (
    <>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Orlando Extended Student Tour", path: "/usa-trips/orlando-schooltrips/orlando-student-tour-extended/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/usa-trips/orlando-schooltrips/orlando-student-tour-extended/",
