...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Los Angeles Field Trip | Landmark Educational Tours", description: "Students explore Los Angeles through iconic attractions, world-class museums, and hands-on cultural experiences that spark creativity and learning.", url: "/usa-trips/los-angeles/los-angeles-field-trip/" },
}
