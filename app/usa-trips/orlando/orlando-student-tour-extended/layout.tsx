...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Orlando Extended Student Tour | Landmark Educational Tours", description: "A five day Orlando adventure pairing Walt Disney World and Universal Studios with immersive group activities students will remember forever.", url: "/usa-trips/orlando/orlando-student-tour-extended/" },
}
