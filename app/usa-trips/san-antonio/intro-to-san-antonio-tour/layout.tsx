...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Intro to San Antonio Tour | Landmark Educational Tours", description: "Spend five days discovering San Antonio's landmarks, missions, and River Walk on an immersive educational adventure for student groups.", url: "/usa-trips/san-antonio/intro-to-san-antonio-tour/" },
}
