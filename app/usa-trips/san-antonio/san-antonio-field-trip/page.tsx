...
const DAYS = [
  { title: "Day 1: Arrival & GO RIO River Cruise", acts: ["Travel to San Antonio, TX", "Welcome to San Antonio! Meet your Tour Director!", "Lunch Included", "GO RIO River Cruise, Narrated Cruise", "Visit the San Fernando Cathedral", "Free time stroll through downtown", "Group sit-down dinner", "Check-in to Hotel Accommodations"] },
