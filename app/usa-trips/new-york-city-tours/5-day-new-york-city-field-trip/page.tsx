  ...
  return (
    <>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "5 Day New York City Field Trip", path: "/usa-trips/new-york-city-tours/5-day-new-york-city-field-trip/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/usa-trips/new-york-city-tours/5-day-new-york-city-field-trip/",
