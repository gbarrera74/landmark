...
const INTERNATIONAL = [
  ...
  { name: 'Norway', href: '/europe/norway/', img: '/images/landmark/intl-norway-group.webp' },
  { name: 'Costa Rica', href: '/central-south-america/costa-rica/', img: '/images/landmark/intl-costa-rica-group.webp' },
]
...
const THEMED = [
  ...
  { location: 'Quebec City, Canada', theme: 'French Immersion', img: '/images/landmark/quebec-city-french-immersion-bridge.webp', href: '/canada/quebec-city/5-day-quebec-city-itinerary/' },
...
const GALLERY = [
  ...
  { img: '/images/landmark/independence-hall.webp', alt: 'Independence Hall in Philadelphia', cls: '' },
...
const POSTS = [
  ...
  { title: 'Top 10 things to do on a Seattle Field Trip', href: '/blog/top-10-things-to-do-on-a-seattle-field-trip/', img: '/images/landmark/seattle-skyline-sunset.webp', alt: 'Seattle skyline at sunset' },
]
