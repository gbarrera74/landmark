...
const INTRO_P1 =
  "France tells a story of art, revolution, and cultural refinement. Through our thoughtfully designed Educational Trips to France, students encounter the ideals of liberty and equality born during the French Revolution alongside centuries of artistic and architectural achievement. Visiting iconic landmarks becomes a catalyst for meaningful reflection and cultural discovery."
const HIGHLIGHTS = [
  "The Louvre Museum and the Palace of Versailles",
  "A cruise on the River Seine",
  "A French-speaking macaron workshop",
  "Saint-Paul-de-Vence and the French Riviera",
  "Monaco and Disneyland Paris",
]
  ...
  return (
    <div className="lm-intl">
      <PageHero
        ...
        image="/images/landmark/france-hero-paris-rooftops.webp"
      ...
      {/* Trips */}
      <section className="ile-section ile-section--cream" aria-labelledby="france-trips-h">
        <div className="ile-container">
          <div className="ile-center lm-narrow">
            <span className="ile-eyebrow">Tours &amp; Itineraries</span>
            <h2 id="france-trips-h" className="lm-h2-amber">FRANCE TRIPS</h2>
            <p className="ile-lead lm-center-lead">Every France program is fully customizable to your group, grade level, subject focus, and budget.</p>
          </div>
      ...
      <section className="ile-section ile-section--white" aria-labelledby="france-handled-h">
        <div className="ile-container">
          <div className="ile-center lm-narrow">
            <span className="ile-eyebrow">The International Difference</span>
            <h2 id="france-handled-h" className="lm-h2-amber">INTERNATIONAL TRAVEL, HANDLED</h2>
      ...
      <section className="ile-section ile-section--cream" aria-labelledby="france-custom-h">
        <div className="ile-container">
          <div className="ile-center lm-narrow">
            <span className="ile-eyebrow">How it works</span>
            <h2 id="france-custom-h" className="lm-h2-amber">CUSTOMIZATION MADE SIMPLE</h2>
