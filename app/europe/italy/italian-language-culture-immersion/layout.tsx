...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Italian Language & Culture Immersion | Landmark Educational Tours", description: "Conversational Italian in the field: markets, cafés, and hill towns, with guided cultural workshops.", url: "/europe/italy/italian-language-culture-immersion/" },
}
