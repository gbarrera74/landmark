  ...
  return (
    <div className="lm-intl">
      ...
      <DestinationIntro
        ...
        image="/images/landmark/italy-intro-colosseum-group.webp"
        wideImage
      ...
      <PageFaq items={PAGE_FAQS['/europe/italy/']} id="italy-faq" heading="Italy school trips: common questions" tone="white" />
