...
const RELATED = [
  ...
  { title: "Pompeii & the Bay of Naples Archaeology Trip", img: "/images/landmark/intl-italy.webp", href: "/europe/italy/pompeii-naples-archaeology-trip/" },
]
  ...
  return (
    <>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Renaissance Florence Art & History Program", path: "/europe/italy/renaissance-florence-art-program/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/europe/italy/renaissance-florence-art-program/",
        days: [],
      })} />
    </>
  )
