...
const DAYS = [
  ...
  { title: "Day 2: Arrival in London", acts: ["Arrive at London Heathrow Airport and meet your Landmark Tour Manager", "Panoramic sightseeing tour of Big Ben, Westminster Abbey, Parliament, and Buckingham Palace", "Lunch in Covent Garden", "Guided walking tour of Trafalgar Square and Whitehall", "Hotel check-in and time to freshen up", "Group welcome dinner", "Return to Hotel Accommodations"] },
