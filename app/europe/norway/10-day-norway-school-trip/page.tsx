...
const DAYS = [
  ...
  { title: "Day 5: Guided Winter Hike & Explore Sogndal, Norway", acts: ["Breakfast at the hotel", "Shuttle Transfer to Ardal, Norway", "Guided Winter Hike (Moderate Hike) to Farmhouse", "Lunch: Group Meal at Farm House", "Hotel Accommodations", "Group sit-down dinner", "Return to Hotel Accommodations"], options: { label: "Optional points of interest in Sogndal", items: ["Glacier Museum", "Sogn Folkmuseum", "Kaupanger Stave Church"] } },
  ...
  { title: "Day 7: Trondelag Folk Museum & Saint Olav’s Cathedral", acts: ["Breakfast at the hotel", "Group Exploration of City Center", "Domestic Flight from Bergen, Norway to Trondheim, Norway", "Trondelag Folk Museum", "Saint Olav’s Cathedral", "Hotel Accommodations", "Group sit-down dinner", "Return to Hotel Accommodations"], options: { label: "Optional points of interest in Bergen", items: ["Troldhaugen (Edvard Grieg Museum)", "Bergenhus Fortress", "Bergen Science Center", "West Norway Museum of Decorative Art", "Norway Fisheries Museum"] } },
  { title: "Day 8: Guided City Walking Tour of Trondheim & Train Ride to Roros", acts: ["Breakfast at the Hotel", "Guided City Walking Tour of Trondheim, Norway with Local Guide", "Train Ride Admission to Roros, Norway", "Hotel Accommodations", "Group sit-down dinner", "Return to Hotel Accommodations"], options: { label: "Optional points of interest in Roros", items: ["Guided Tour of Olavs Mine (Copper!)", "Reindeer Experience and Sami Culture Workshop (Includes Dinner)", "Kennel Dolanvollen Dog Sledding Roros", "Guided City Walking Tour of Roros, Norway with Local Guide"] } },
  { title: "Day 9: Explore Roros, Norway", acts: ["Breakfast at the Hotel", "Lunch: Local Speciality Lunch", "Group Exploration and Free Time", "Group sit-down dinner", "Return to Hotel Accommodations"], options: { label: "Optional points of interest in Roros", items: ["Guided Tour of Olavs Mine (Copper!)", "Reindeer Experience and Sami Culture Workshop (Includes Dinner)", "Kennel Dolanvollen Dog Sledding Roros", "Guided City Walking Tour of Roros, Norway with Local Guide"] } },
    ...
    <div className="ilp-timeline lm-day-timeline">
      {DAYS.map((d, i) => (
        <div className="ilp-step" key={d.title}>
          ...
          {d.options && (
            <div className="lm-day-options">
              <p className="lm-day-options-label">
                {d.options.label} <span>— choose from these, not all included</span>
              </p>
              <ul>
  ...
  return (
    <>
      <PageHero
        ...
        image="/images/landmark/norway-10day-fjord-group.webp"
        breadcrumb={[
        ...
        <div className="ile-container lm-itin-grid">
          ...
          <aside className="lm-itin-side">
            <div className="lm-summary-card">
              ...
              <Link href="/europe/norway/" className="lm-summary-link">More Norway packages {ArrowR}</Link>
            </div>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "10 Day Norway School Trip", path: "/europe/norway/10-day-norway-school-trip/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/europe/norway/10-day-norway-school-trip/",
        // Derived from DAYS so the structured data can never drift from the page.
        days: DAYS.map((d) => ({
          name: d.title,
          description: [
            ...d.acts,
            ...(d.options ? [d.options.label + " (choose from): " + d.options.items.join(", ")] : []),
          ].join("; "),
        })),
      })} />
    </>
