...
export const metadata: Metadata = {
  ...
  openGraph: { title: "10 Day Norway School Trip | Landmark Educational Tours", description: "Ten days across Oslo, Bergen, and Norway's fjords, where students explore Viking heritage, glaciers, and sustainability up close.", url: "/europe/norway/10-day-norway-school-trip/" },
}
