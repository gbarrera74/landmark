...
const TRIPS = [
  { title: "10 Day Norway School Trip", duration: "10 Day / 9 Night", img: '/images/landmark/norway-10day-bergen-bryggen-group.webp', href: "/europe/norway/10-day-norway-school-trip/" },
]
  ...
  return (
    <div className="lm-intl">
      ...
      <DestinationIntro
        ...
        image="/images/landmark/norway-10day-hilltop-group.webp"
        wideImage
