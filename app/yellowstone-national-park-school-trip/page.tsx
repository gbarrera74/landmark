...
const DAYS = [
  { title: "Day 1: Travel to Wyoming & Ziplining or White Water Rafting", acts: ["Travel to Wyoming!", "Meet your Tour Director!", "Lunch Allocation", "Ziplining or White Water Rafting in Gallatin National Forest", "Group sit-down dinner", "Walk around Downtown Bozeman", "Return to Hotel Accommodations"] },
