...
const RELATED = [
  ...
  { title: "Montreal Student Trip", img: "/images/landmark/montreal-hero.jpg", href: "/canada/montreal/montreal-student-trip/" },
]

const DESC_P1 = "Set out on an exciting two-day educational adventure in Montreal, designed to inspire students of all grade levels! Discover the city’s rich history, French-Canadian culture, and stunning architecture with visits to landmarks such as Old Montreal, Notre-Dame Basilica, and Mount Royal. From exploring world-class museums to engaging in immersive cultural experiences, this trip promises a hands-on learning journey that will leave students excited about history, language, and the unique charm of Montreal."

const sampleTab = (
  <>
    <p className="lm-itin-note">*Customize and personalize your 2 Day Montreal School Trip itinerary with our team.</p>
...
const descriptionTab = (
  <div className="ilp-prose">
    <h2 style={{ marginTop: 0 }}>The Ultimate 2 Day Montreal School Trip Experience</h2>
    <p>{DESC_P1}</p>
...
export default function Itin_international__canada__montreal__2_day_montreal_school_trip() {
  return (
    <>
      <PageHero
        ...
        image="/images/landmark/montreal-1.jpg"
        breadcrumb={[
        { label: "Destinations", href: "/destinations/" },
        { label: "Canada", href: "/canada/" },
        { label: "Montreal", href: "/canada/montreal/" },
        { label: "2 Day Montreal School Trip" },
      ]}
      />
        ...
        <div className="ile-container lm-itin-grid">
          ...
          <aside className="lm-itin-side">
            <div className="lm-summary-card">
              ...
              <Link href="/canada/montreal/" className="lm-summary-link">More Montreal packages {ArrowR}</Link>
            </div>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "2 Day Montreal School Trip", path: "/canada/montreal/2-day-montreal-school-trip/" },
      ])} />
