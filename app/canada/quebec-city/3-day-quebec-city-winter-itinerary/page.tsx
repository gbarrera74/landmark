  ...
  return (
    <>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "3 Day Quebec City Winter Itinerary", path: "/canada/quebec-city/3-day-quebec-city-winter-itinerary/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/canada/quebec-city/3-day-quebec-city-winter-itinerary/",
