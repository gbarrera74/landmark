  ...
  return (
    <>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "4 Day Quebec City Winter Itinerary", path: "/canada/quebec-city/4-day-quebec-city-winter-itinerary/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/canada/quebec-city/4-day-quebec-city-winter-itinerary/",
