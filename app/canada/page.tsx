...
const INTRO_P2 =
  "We handle group travel, dedicated Tour Directors, and safe accommodations from start to finish, so teachers can focus on their students and their students can focus on the experience."
...
export default function Canada() {
  return (
    <div className="lm-intl">
      ...
      <PageFaq items={PAGE_FAQS['/canada/']} id="canada-faq" heading="Canada school trips: common questions" tone="white" />
      ...
      <JsonLd data={itemList("Canada student trip destinations", [{ name: "Quebec City", path: "/canada/quebec-city/" }, { name: "Montreal", path: "/canada/montreal/" }])} />
    </div>
  )
}
