...
const TEAM = [
  ...
  { name: `Angela Gallagher`, title: `Account Manager`, bio: `Hi my name is Angela and I am so excited to be apart of the Landmark team. I currently live in Phoenix, AZ with my husband and golden doodle puppy named Stella! I graduated from the University of Arizona with a degree in Elementary Education. During my time at Arizona I was able to study Art History abroad in Prague, Czech Republic where my love for travel and history began. I have been to 25 different states and 12 countries. In my free time I love to go for walks, go to Orangetheory, and be with friends and family.`, photo: `/images/landmark/team/angela.jpg` },
  ...
  { name: `Briana Kotchen`, title: `Marketing Specialist`, bio: `Currently, in Minneapolis Minnesota, Briana is a new addition to our marketing team! She is passionate about marketing, social media, and traveling. Briana is a creative individual, she enjoys sharing her ideas with others and being able to come together as a team to achieve different goals. In her free time, she enjoys watching sports, baking, and spending time with her family and friends. Dream Destinations: Greece, Australia, London, and Puerto Rico!`, photo: `/images/landmark/team/briana.jpg` },
