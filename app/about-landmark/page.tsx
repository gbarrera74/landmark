...
const TEAM = [
  // Ordered client-facing first (Michaela, 7/30): leadership, then Travel
  // Consultants / Tour Directors / Account Managers, then marketing, then
  // operations and back office. Members without a headshot sit last within
  // their group so the top of the grid is all faces.
