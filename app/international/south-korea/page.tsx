...
export default function SouthKorea() {
  return (
    <div className="lm-intl">
      <PageHero
        eyebrow="International · South Korea"
        ...
        breadcrumb={[{ label: 'Destinations', href: '/destinations/' }, { label: 'International', href: '/international/' }, { label: "South Korea" }]}
      />
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "South Korea", path: "/international/south-korea/" },
      ])} />
    </div>
  )
}
