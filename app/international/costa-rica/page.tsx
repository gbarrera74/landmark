...
const TRIPS = [
  { title: "7 Day Costa Rica School Trip", duration: "7 Day / 6 Night", img: '/images/landmark/costa-rica-1.jpg', href: "/international/costa-rica/7-day-costa-rica-school-trip/" },
  { title: "6 Day Costa Rica School Trip", duration: "6 Day / 5 Night", img: '/images/landmark/costa-rica-2.jpg', href: "/international/costa-rica/6-day-costa-rica-school-trip/" },
]
...
export default function CostaRica() {
  return (
    <div className="lm-intl">
      <PageHero
        eyebrow="International · Costa Rica"
        ...
        breadcrumb={[{ label: 'Destinations', href: '/destinations/' }, { label: 'International', href: '/international/' }, { label: "Costa Rica" }]}
      />
