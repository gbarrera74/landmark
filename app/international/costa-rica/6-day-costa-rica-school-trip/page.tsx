...
const RELATED = [
  { title: "7 Day Costa Rica School Trip", img: "/images/landmark/costa-rica-1.jpg", href: "/international/costa-rica/7-day-costa-rica-school-trip/" },
]
  ...
  return (
    <>
        ...
        <div className="ile-container lm-itin-grid">
          ...
          <aside className="lm-itin-side">
            <div className="lm-summary-card">
              ...
              <Link href="/international/costa-rica/" className="lm-summary-link">More Costa Rica packages {ArrowR}</Link>
            </div>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Costa Rica", path: "/international/costa-rica/" },
        { name: "6 Day Costa Rica School Trip", path: "/international/costa-rica/6-day-costa-rica-school-trip/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/international/costa-rica/6-day-costa-rica-school-trip/",
