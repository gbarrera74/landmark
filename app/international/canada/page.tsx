...
const INTRO_P1 =
  "Canada brings French heritage, walled cities, and cosmopolitan energy within easy reach of the Northeast. Landmark's Canada programs center on Quebec City and Montreal, where students practice French, trace colonial history, and experience a culture that feels a world away just across the border."
const INTRO_P2 =
  "We handle passports, group travel, licensed local guides, and safe accommodations from start to finish, so teachers can focus on their students and their students can focus on the experience."
  ...
  return (
    <div className="lm-intl">
      <PageHero
        ...
        breadcrumb={[{ label: "Destinations", href: "/destinations/" }, { label: "International", href: "/international/" }, { label: "Canada" }]}
      />
      ...
      {/* Where to go */}
      <section className="ile-section ile-section--cream" aria-labelledby="canada-where-h">
        <div className="ile-container">
          <div className="ile-center lm-narrow">
            <span className="ile-eyebrow">Where to Go</span>
            <h2 id="canada-where-h" className="lm-h2-amber">EXPLORE CANADA</h2>
            <p className="ile-lead lm-center-lead">Our Canada programs center on two French-speaking cities, each a short flight or drive from the Northeast.</p>
          </div>
          <div className="lm-intl-grid" style={{ marginTop: 8 }}>
            <Link href="/international/canada/quebec-city/" className="lm-dest" key="Quebec City" aria-label="Quebec City educational tours">
            ...
            <Link href="/international/canada/montreal/" className="lm-dest" key="Montreal" aria-label="Montreal educational tours">
      ...
      <section className="ile-section ile-section--white" aria-labelledby="canada-handled-h">
        <div className="ile-container">
          <div className="ile-center lm-narrow">
            <span className="ile-eyebrow">The International Difference</span>
            <h2 id="canada-handled-h" className="lm-h2-amber">INTERNATIONAL TRAVEL, HANDLED</h2>
      ...
      <section className="ile-section ile-section--cream" aria-labelledby="canada-custom-h">
        <div className="ile-container">
          <div className="ile-center lm-narrow">
            <span className="ile-eyebrow">How it works</span>
            <h2 id="canada-custom-h" className="lm-h2-amber">CUSTOMIZATION MADE SIMPLE</h2>
