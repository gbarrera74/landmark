...
const TRIPS = [
  { title: "2 Day Montreal School Trip", duration: "2 Day / 1 Night", img: "/images/landmark/montreal-1.jpg", href: "/international/canada/montreal/2-day-montreal-school-trip/" },
  { title: "3 Day Montreal School Trip", duration: "3 Day / 2 Night", img: "/images/landmark/montreal-2.jpg", href: "/international/canada/montreal/3-day-montreal-school-trip/" },
  { title: "Montreal Student Trip", duration: "3 Day / 2 Night", img: "/images/landmark/montreal-hero.jpg", href: "/international/canada/montreal/montreal-student-trip/" },
]
  ...
  return (
    <div className="lm-intl">
      <PageHero
        ...
        breadcrumb={[{ label: "Destinations", href: "/destinations/" }, { label: "International", href: "/international/" }, { label: "Canada", href: "/international/canada/" }, { label: "Montreal" }]}
      />
