...
const DESC_P1 = "Set out on an exciting educational adventure in Montreal, designed to inspire students of all grade levels! Discover the city’s rich history, French-Canadian culture, and stunning architecture with visits to iconic landmarks such as Old Montreal, Notre-Dame Basilica, and Mount Royal. From exploring world-class museums to engaging in immersive cultural experiences, this trip promises a hands-on learning journey that will leave students excited about history, language, and the vibrant charm of Montreal."

const sampleTab = (
  <>
    <p className="lm-itin-note">*Customize and personalize your Montreal Student Trip itinerary with our team.</p>
...
const descriptionTab = (
  <div className="ilp-prose">
    <h2 style={{ marginTop: 0 }}>The Ultimate Montreal Student Trip Experience</h2>
    <p>{DESC_P1}</p>
...
export default function Itin_international__canada__montreal__montreal_student_trip() {
  return (
    <>
      <PageHero
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Montreal Student Trip", path: "/international/canada/montreal/montreal-student-trip/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/international/canada/montreal/montreal-student-trip/",
