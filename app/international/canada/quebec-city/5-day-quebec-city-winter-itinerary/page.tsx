  ...
  return (
    <>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "5 Day Quebec City Winter Itinerary", path: "/international/canada/quebec-city/5-day-quebec-city-winter-itinerary/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/international/canada/quebec-city/5-day-quebec-city-winter-itinerary/",
