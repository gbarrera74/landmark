...
const DAYS = [
  { title: "Day 1: Arrival & les Glissades de la Terrasse", acts: ["Travel to Quebec City.", "Check into Hotel Accommodations.", "Guided Quebec City Walking Tour.", "Enjoy a sit-down dinner.", "Explore les Glissades de la Terrasse.", "Return to Hotel Accommodations with Overnight Security."] },
  { title: "Day 2: Château Frontenac & Village Vacances", acts: ["Breakfast at Café Buade.", "Take a group photograph on the boardwalk outside the Château Frontenac.", "Visit La Citadelle de Québec.", "Lunch at Les Galeries de la Capitale.", "Visit Village Vacances.", "Enjoy a sit-down dinner and dancing at cabane à sucre.", "Return to Hotel Accommodations with Overnight Security."] },
  { title: "Day 3: Parc de la Chutes Montmorency & Basilique Ste-Anne", acts: ["Breakfast at le Cochon Dingue.", "Visit Parc de la Chutes Montmorency.", "Visit Basilique Ste-Anne.", "Return to the city for lunch on your own.", "Visit National Battlefields Commission’s Martello Tower.", "Enjoy a sit-down dinner at L’Entrecote St-Jean.", "Explore les Glissades de la Terrasse.", "Return to Hotel Accommodations with Overnight Security."] },
  { title: "Day 4: Musee du Fort & Departure", acts: ["Breakfast at le Cafe Les Mordus.", "Visit the Musee du Fort.", "Take the funiculaire to the Upper Town.", "Lunch on your own on rue du Petit Champlain.", "Take the ferry and say au revoir to Quebec City.", "Depart for home."] },
]
...
const DESC_P1 = "Embark on an exciting four-day educational adventure in Quebec City, designed to immerse students in the magic of winter! Explore the charming streets of Old Quebec, admire the iconic Château Frontenac, and experience the rich history of this UNESCO World Heritage Site. From witnessing the frozen beauty of Montmorency Falls to enjoying thrilling winter activities like tobogganing, ice skating, and visiting the world-famous Quebec Winter Carnival, this trip promises an immersive, hands-on learning experience that will leave students inspired by history, culture, and the wonders of winter in Quebec City."

const sampleTab = (
  <>
    <p className="lm-itin-note">*Customize and personalize your 4 Day Quebec City Winter Itinerary itinerary with our team.</p>
...
const descriptionTab = (
  <div className="ilp-prose">
    <h2 style={{ marginTop: 0 }}>Explore the Ultimate 4 Day Quebec City Winter Itinerary</h2>
    <p>{DESC_P1}</p>
...
export default function Itin_international__canada__quebec_city__4_day_quebec_city_winter_itinerary() {
  return (
    <>
      <PageHero
        ...
        { label: "4 Day Quebec City Winter Itinerary" },
      ]}
      />
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "4 Day Quebec City Winter Itinerary", path: "/international/canada/quebec-city/4-day-quebec-city-winter-itinerary/" },
      ])} />
      <JsonLd data={touristTrip({
        name: "4 Day Quebec City Winter Itinerary",
        description: "Give students four unforgettable days exploring historic Old Quebec, iconic landmarks, and thrilling winter activities in Canada's oldest fortified city.",
        path: "/international/canada/quebec-city/4-day-quebec-city-winter-itinerary/",
        days: [{ name: "Day 1: Arrival & les Glissades de la Terrasse", description: "Travel to Quebec City.; Check into Hotel Accommodations.; Guided Quebec City Walking Tour.; Enjoy a sit-down dinner.; Explore les Glissades de la Terrasse.; Return to Hotel Accommodations with Overnight Security." }, { name: "Day 2: Château Frontenac & Village Vacances", description: "Breakfast at Café Buade.; Take a group photograph on the boardwalk outside the Château Frontenac.; Visit La Citadelle de Québec.; Lunch at Les Galeries de la Capitale.; Visit Village Vacances.; Enjoy a sit-down dinner and dancing at cabane à sucre.; Return to Hotel Accommodations with Overnight Security." }, { name: "Day 3: Parc de la Chutes Montmorency & Basilique Ste-Anne", description: "Breakfast at le Cochon Dingue.; Visit Parc de la Chutes Montmorency.; Visit Basilique Ste-Anne.; Return to the city for lunch on your own.; Visit National Battlefields Commission’s Martello Tower.; Enjoy a sit-down dinner at L’Entrecote St-Jean.; Explore les Glissades de la Terrasse.; Return to Hotel Accommodations with Overnight Security." }, { name: "Day 4: Musee du Fort & Departure", description: "Breakfast at le Cafe Les Mordus.; Visit the Musee du Fort.; Take the funiculaire to the Upper Town.; Lunch on your own on rue du Petit Champlain.; Take the ferry and say au revoir to Quebec City.; Depart for home." }],
      })} />
    </>
  )
}
