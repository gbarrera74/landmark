...
const TRIPS = [
  { title: "3 Day Quebec City Trip Itinerary", duration: "3 Day / 2 Night", img: "/images/landmark/quebec-1.jpg", href: "/international/canada/quebec-city/3-day-quebec-city-itinerary/" },
  { title: "4 Day Quebec City Trip Itinerary", duration: "4 Day / 3 Night", img: "/images/landmark/quebec-1.jpg", href: "/international/canada/quebec-city/4-day-quebec-city-itinerary/" },
  { title: "5 Day Quebec City Trip Itinerary", duration: "5 Day / 4 Night", img: "/images/landmark/quebec-1.jpg", href: "/international/canada/quebec-city/5-day-quebec-city-itinerary/" },
  { title: "3 Day Quebec City Winter Itinerary", duration: "3 Day / 2 Night", img: "/images/landmark/quebec-winter.jpg", href: "/international/canada/quebec-city/3-day-quebec-city-winter-itinerary/" },
  { title: "4 Day Quebec City Winter Itinerary", duration: "4 Day / 3 Night", img: "/images/landmark/quebec-winter.jpg", href: "/international/canada/quebec-city/4-day-quebec-city-winter-itinerary/" },
  { title: "5 Day Quebec City Winter Itinerary", duration: "5 Day / 4 Night", img: "/images/landmark/quebec-winter.jpg", href: "/international/canada/quebec-city/5-day-quebec-city-winter-itinerary/" },
]
...
export default function QuebecCity() {
  return (
    <div className="lm-intl">
      <PageHero
        eyebrow="Canada · Quebec City"
        title={<>Educational Trips to <em>Quebec City</em></>}
        subtitle="The only walled city north of Mexico: cobblestone streets, the Chateau Frontenac, French immersion, and a world-famous Winter Carnival."
        image="/images/landmark/quebec-hero.jpg"
        breadcrumb={[{ label: "Destinations", href: "/destinations/" }, { label: "International", href: "/international/" }, { label: "Canada", href: "/international/canada/" }, { label: "Quebec City" }]}
      />
      ...
      <section className="ile-section ile-section--cream" aria-labelledby="quebec-trips-h">
        <div className="ile-container">
          <div className="ile-center lm-narrow">
            ...
            <h2 id="quebec-trips-h" className="lm-h2-amber">QUEBEC CITY ITINERARIES</h2>
            <p className="ile-lead lm-center-lead">Every Quebec City program is fully customizable to your group, grade level, subject focus, and budget.</p>
          </div>
          ...
          <div className="ile-center lm-after-grid">
            <Link href="/international/canada/" className="ile-btn ile-btn--ghost">More Canada Trips</Link>
          </div>
        </div>
      </section>

      {/* International-only: Travel, Handled */}
      <section className="ile-section ile-section--white" aria-labelledby="quebec-handled-h">
        <div className="ile-container">
          <div className="ile-center lm-narrow">
            <span className="ile-eyebrow">The International Difference</span>
            <h2 id="quebec-handled-h" className="lm-h2-amber">INTERNATIONAL TRAVEL, HANDLED</h2>
      ...
      <section className="ile-section ile-section--cream" aria-labelledby="quebec-custom-h">
        <div className="ile-container">
          <div className="ile-center lm-narrow">
            <span className="ile-eyebrow">How it works</span>
            <h2 id="quebec-custom-h" className="lm-h2-amber">CUSTOMIZATION MADE SIMPLE</h2>
