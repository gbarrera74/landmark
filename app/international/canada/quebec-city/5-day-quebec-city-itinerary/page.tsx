...
const DAYS = [
  { title: "Day 1: Arrival & Terrasse Dufferin", acts: ["Travel to Quebec City.", "Check into Hotel Accommodations.", "Guided Quebec City Walking Tour.", "Enjoy a sit-down dinner.", "Take a group photo on the boardwalk outside Château Frontenac.", "Return to Hotel Accommodations with Overnight Security."] },
  { title: "Day 2: La Citadelle de Québec & Complexe G observatory", acts: ["Breakfast at Café Buade.", "Visit La Citadelle de Québec.", "Lunch on your own in Upper or Lower Town.", "Visit the Musée de la Civilisation.", "See Quebec from the top of Complexe G observatory.", "Enjoy a sit-down dinner and dancing at Cabane a Sucre .", "Return to Hotel Accommodations with Overnight Security."] },
  { title: "Day 3: Parc de la Chutes Montmorency & Village Hurons Wendat", acts: ["Breakfast at Quartier Petit Champlain.", "Visit Parc de la Chutes Montmorency .", "Visit Basilique Ste-Anne .", "Lunch at food court les Galeries de la Capitale .", "Visit the Village Hurons Wendat .", "Scavenger Treasure Hunt in Upper Town (optional).", "Enjoy a sit-down dinner.", "Visit National Battlefields Commission’s Martello Tower. (Or Plains of Abraham “Le Militaire” activity).", "Return to Hotel Accommodations with Overnight Security."] },
  { title: "Day 4: Morrin Center Quebec & Chateau Frontenac", acts: ["Breakfast at La Buche.", "Visit the Morrin Center Quebec.", "Lunch on your own in Upper Town.", "Guided tour of Chateau Frontenac.", "Return to hotel and change for this evening dinner and activity.", "Enjoy a sit down dinner at L’Entrecote St-Jean.", "Return to Hotel Accommodations with Overnight Security."] },
  { title: "Day 5: Musee du Fort & Departure", acts: ["Breakfast at le Cafe Les Mordus.", "Visit the Musee du Fort.", "Take the funiculaire to the Lower Town.", "Lunch on your own on rue du Petit Champlain.", "Take the ferry and say au revoir to Quebec City.", "Depart for home."] },
]
...
const RELATED = [
  { title: "3 Day Quebec City Trip Itinerary", img: "/images/landmark/quebec-1.jpg", href: "/international/canada/quebec-city/3-day-quebec-city-itinerary/" },
...
const DESC_P1 = "Embark on an exciting five-day educational adventure in Quebec City, designed to inspire students of all grade levels! Discover the city’s rich history, stunning architecture, and vibrant French-Canadian culture with visits to Old Quebec, the Plains of Abraham, and the iconic Château Frontenac. From exploring breathtaking natural wonders like Montmorency Falls to engaging in hands-on cultural experiences and immersive language opportunities, this trip promises an unforgettable learning journey that will leave students excited about history, culture, and the unique charm of Quebec City."

const sampleTab = (
  <>
    <p className="lm-itin-note">*Customize and personalize your 5 Day Quebec City Trip Itinerary itinerary with our team.</p>
...
const descriptionTab = (
  <div className="ilp-prose">
    <h2 style={{ marginTop: 0 }}>Explore the Ultimate 5 Day Quebec City Itinerary</h2>
    <p>{DESC_P1}</p>
...
export default function Itin_international__canada__quebec_city__5_day_quebec_city_itinerary() {
  return (
    <>
      <PageHero
        ...
        { label: "5 Day Quebec City Trip Itinerary" },
      ]}
      />
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "5 Day Quebec City Trip Itinerary", path: "/international/canada/quebec-city/5-day-quebec-city-itinerary/" },
      ])} />
      <JsonLd data={touristTrip({
        name: "5 Day Quebec City Trip Itinerary",
        description: "Spend five days exploring Old Quebec, Montmorency Falls, and French-Canadian culture on an educational adventure built for student groups.",
        path: "/international/canada/quebec-city/5-day-quebec-city-itinerary/",
        days: [{ name: "Day 1: Arrival & Terrasse Dufferin", description: "Travel to Quebec City.; Check into Hotel Accommodations.; Guided Quebec City Walking Tour.; Enjoy a sit-down dinner.; Take a group photo on the boardwalk outside Château Frontenac.; Return to Hotel Accommodations with Overnight Security." }, { name: "Day 2: La Citadelle de Québec & Complexe G observatory", description: "Breakfast at Café Buade.; Visit La Citadelle de Québec.; Lunch on your own in Upper or Lower Town.; Visit the Musée de la Civilisation.; See Quebec from the top of Complexe G observatory.; Enjoy a sit-down dinner and dancing at Cabane a Sucre .; Return to Hotel Accommodations with Overnight Security." }, { name: "Day 3: Parc de la Chutes Montmorency & Village Hurons Wendat", description: "Breakfast at Quartier Petit Champlain.; Visit Parc de la Chutes Montmorency .; Visit Basilique Ste-Anne .; Lunch at food court les Galeries de la Capitale .; Visit the Village Hurons Wendat .; Scavenger Treasure Hunt in Upper Town (optional).; Enjoy a sit-down dinner.; Visit National Battlefields Commission’s Martello Tower. (Or Plains of Abraham “Le Militaire” activity).; Return to Hotel Accommodations with Overnight Security." }, { name: "Day 4: Morrin Center Quebec & Chateau Frontenac", description: "Breakfast at La Buche.; Visit the Morrin Center Quebec.; Lunch on your own in Upper Town.; Guided tour of Chateau Frontenac.; Return to hotel and change for this evening dinner and activity.; Enjoy a sit down dinner at L’Entrecote St-Jean.; Return to Hotel Accommodations with Overnight Security." }, { name: "Day 5: Musee du Fort & Departure", description: "Breakfast at le Cafe Les Mordus.; Visit the Musee du Fort.; Take the funiculaire to the Lower Town.; Lunch on your own on rue du Petit Champlain.; Take the ferry and say au revoir to Quebec City.; Depart for home." }],
      })} />
    </>
  )
}
