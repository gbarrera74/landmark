  ...
  return (
    <>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "4 Day Quebec City Trip Itinerary", path: "/international/canada/quebec-city/4-day-quebec-city-itinerary/" },
      ])} />
      <JsonLd data={touristTrip({
        ...
        path: "/international/canada/quebec-city/4-day-quebec-city-itinerary/",
