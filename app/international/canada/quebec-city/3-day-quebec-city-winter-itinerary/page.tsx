...
const DAYS = [
  { title: "Day 1: Arrival & Guided Quebec City Walking Tour", acts: ["Travel to Quebec City.", "Check into Hotel Accommodations.", "Guided Quebec City Walking Tour.", "Enjoy a sit-down dinner.", "Attend the Soldier of the Martello Tower activity.", "Return to Hotel Accommodations with Overnight Security."] },
  { title: "Day 2: La Citadelle de Québec & Parc de la Chutes Montmorency", acts: ["Breakfast at La Buche.", "Visit La Citadelle de Québec.", "Visit Parc de la Chutes Montmorency.", "Lunch at Les Galeries de la Capitale.", "Visit Village Vacances .", "Enjoy a sit-down dinner and dancing at cabane à sucre .", "Return to Hotel Accommodations with Overnight Security."] },
  { title: "Day 3: Musee du Fort & Departure", acts: ["Breakfast at le Cafe Les Mordus.", "Visit the Musee du Fort.", "Take the funiculaire to the Upper Town.", "Lunch on your own on rue du Petit Champlain.", "Take the ferry and say au revoir to Quebec City.", "Depart for home."] },
]
...
const sampleTab = (
  <>
    <p className="lm-itin-note">*Customize and personalize your 3 Day Quebec City Winter Itinerary itinerary with our team.</p>
...
const descriptionTab = (
  <div className="ilp-prose">
    <h2 style={{ marginTop: 0 }}>Explore the Ultimate 3 Day Quebec City Winter Itinerary</h2>
    <p>{DESC_P1}</p>
...
export default function Itin_international__canada__quebec_city__3_day_quebec_city_winter_itinerary() {
  return (
    <>
      <PageHero
        ...
        { label: "3 Day Quebec City Winter Itinerary" },
      ]}
      />
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "3 Day Quebec City Winter Itinerary", path: "/international/canada/quebec-city/3-day-quebec-city-winter-itinerary/" },
      ])} />
      <JsonLd data={touristTrip({
        name: "3 Day Quebec City Winter Itinerary",
        description: "A three day winter journey through historic Quebec City, blending French Canadian culture, iconic landmarks, and hands-on seasonal adventure for student groups.",
        path: "/international/canada/quebec-city/3-day-quebec-city-winter-itinerary/",
        days: [{ name: "Day 1: Arrival & Guided Quebec City Walking Tour", description: "Travel to Quebec City.; Check into Hotel Accommodations.; Guided Quebec City Walking Tour.; Enjoy a sit-down dinner.; Attend the Soldier of the Martello Tower activity.; Return to Hotel Accommodations with Overnight Security." }, { name: "Day 2: La Citadelle de Québec & Parc de la Chutes Montmorency", description: "Breakfast at La Buche.; Visit La Citadelle de Québec.; Visit Parc de la Chutes Montmorency.; Lunch at Les Galeries de la Capitale.; Visit Village Vacances .; Enjoy a sit-down dinner and dancing at cabane à sucre .; Return to Hotel Accommodations with Overnight Security." }, { name: "Day 3: Musee du Fort & Departure", description: "Breakfast at le Cafe Les Mordus.; Visit the Musee du Fort.; Take the funiculaire to the Upper Town.; Lunch on your own on rue du Petit Champlain.; Take the ferry and say au revoir to Quebec City.; Depart for home." }],
      })} />
    </>
  )
}
