...
const TRIPS = [
  { title: "10 Day Norway School Trip", duration: "10 Day / 9 Night", img: '/images/landmark/norway-1.jpg', href: "/international/norway/10-day-norway-school-trip/" },
]
  ...
  return (
    <div className="lm-intl">
      <PageHero
        ...
        breadcrumb={[{ label: 'Destinations', href: '/destinations/' }, { label: 'International', href: '/international/' }, { label: "Norway" }]}
      />
