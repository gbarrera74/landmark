  ...
  return (
    <div className="lm-intl">
      <PageHero
        ...
        breadcrumb={[{ label: 'Destinations', href: '/destinations/' }, { label: 'International', href: '/international/' }, { label: "Ireland" }]}
      />
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Ireland", path: "/international/ireland/" },
      ])} />
    </div>
  )
}
