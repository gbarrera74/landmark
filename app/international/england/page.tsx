  ...
  return (
    <div className="lm-intl">
      <PageHero
        ...
        breadcrumb={[{ label: 'Destinations', href: '/destinations/' }, { label: 'International', href: '/international/' }, { label: "England" }]}
      />
      ...
      <section className="ile-section ile-section--white" aria-labelledby="england-handled-h">
        <div className="ile-container">
          <div className="ile-center lm-narrow">
            <span className="ile-eyebrow">The International Difference</span>
            <h2 id="england-handled-h" className="lm-h2-amber">INTERNATIONAL TRAVEL, HANDLED</h2>
      ...
      <section className="ile-section ile-section--cream" aria-labelledby="england-custom-h">
        <div className="ile-container">
          <div className="ile-center lm-narrow">
            <span className="ile-eyebrow">How it works</span>
            <h2 id="england-custom-h" className="lm-h2-amber">CUSTOMIZATION MADE SIMPLE</h2>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "England", path: "/international/england/" },
      ])} />
    </div>
  )
}
