...
const INTRO_P2 =
  "Our educational tours in France weave together history, art, and language into one cohesive learning journey. From standing before world-famous works of art to exploring grand palaces and historic city streets, each stop invites students to think critically about how the past continues to shape the present. Landmark Educational Tours handles the coordination so that educators can focus on facilitating meaningful discussions. Educational Trips to France leave students empowered with a broader worldview and a deeper appreciation for history, art, and culture."
  ...
  return (
    <div className="lm-intl">
      <PageHero
        ...
        breadcrumb={[{ label: 'Destinations', href: '/destinations/' }, { label: 'International', href: '/international/' }, { label: "France" }]}
      />
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "France", path: "/international/france/" },
      ])} />
    </div>
  )
}
