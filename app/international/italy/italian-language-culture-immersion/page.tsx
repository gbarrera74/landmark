...
const descriptionTab = (
  <div className="ilp-prose">
    <h2 style={{ marginTop: 0 }}>Italian Language &amp; Culture Immersion</h2>
    <p>{DESC_P1}</p>
...
export default function Itin_international__italy__italian_language_culture_immersion() {
  return (
    <>
      <PageHero
        eyebrow="Italy · 9 Day / 8 Night"
        title={<>Italian Language &amp; Culture Immersion</>}
        subtitle="Conversational Italian in the field: markets, cafés, and hill towns, with guided cultural workshops."
        image="/images/landmark/italy-tuscany.webp"
        breadcrumb={[
        { label: "Destinations", href: "/destinations/" },
        { label: "International", href: "/international/" },
        { label: "Italy", href: "/international/italy/" },
        { label: "Italian Language & Culture Immersion" },
      ]}
      />
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Italian Language & Culture Immersion", path: "/international/italy/italian-language-culture-immersion/" },
      ])} />
      <JsonLd data={touristTrip({
        name: "Italian Language & Culture Immersion",
        description: "Conversational Italian in the field: markets, cafés, and hill towns, with guided cultural workshops.",
        path: "/international/italy/italian-language-culture-immersion/",
        days: [],
      })} />
    </>
  )
