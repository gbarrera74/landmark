...
const RELATED = [
  ...
  { title: "Renaissance Florence Art & History Program", img: "/images/landmark/italy-florence.webp", href: "/international/italy/renaissance-florence-art-program/" },
...
const DESC_P1 = "Walk the excavated streets of Pompeii and take in the Amalfi Coast: ancient Roman daily life, uncovered. A full day-by-day sample itinerary for this program is on the way. Every Landmark trip is fully customized to your group, so our Travel Consultants will build your ideal Pompeii & the Bay of Naples Archaeology Trip around your dates, grade level, and curriculum goals."

const sampleTab = (
  <>
    <div className="ilp-infocard">
      <h3>A detailed day-by-day sample is on the way.</h3>
      <p style={{ color: 'var(--lm-ink-muted)', fontSize: 15, lineHeight: 1.7 }}>Every Landmark trip is fully customized to your group, so we build your ideal Pompeii &amp; the Bay of Naples Archaeology Trip itinerary together around your dates, grade level, and goals. Reach out and our Travel Consultants will map out the perfect schedule.</p>
...
const descriptionTab = (
  <div className="ilp-prose">
    <h2 style={{ marginTop: 0 }}>Pompeii &amp; the Bay of Naples Archaeology Trip</h2>
    <p>{DESC_P1}</p>
...
export default function Itin_international__italy__pompeii_naples_archaeology_trip() {
  return (
    <>
      <PageHero
        eyebrow="Italy · 8 Day / 7 Night"
        title={<>Pompeii &amp; the Bay of Naples Archaeology Trip</>}
        subtitle="Walk the excavated streets of Pompeii and take in the Amalfi Coast: ancient Roman daily life, uncovered."
        image="/images/landmark/intl-italy.webp"
        breadcrumb={[
        { label: "Destinations", href: "/destinations/" },
        { label: "International", href: "/international/" },
        { label: "Italy", href: "/international/italy/" },
        { label: "Pompeii & the Bay of Naples Archaeology Trip" },
      ]}
      />
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Pompeii & the Bay of Naples Archaeology Trip", path: "/international/italy/pompeii-naples-archaeology-trip/" },
      ])} />
      <JsonLd data={touristTrip({
        name: "Pompeii & the Bay of Naples Archaeology Trip",
        description: "Walk the excavated streets of Pompeii and take in the Amalfi Coast: ancient Roman daily life, uncovered.",
        path: "/international/italy/pompeii-naples-archaeology-trip/",
        days: [],
      })} />
    </>
  )
