...
const DESC_P1 = "Italy’s three essential cities in one itinerary: history, art, and language across the whole peninsula. A full day-by-day sample itinerary for this program is on the way. Every Landmark trip is fully customized to your group, so our Travel Consultants will build your ideal Rome, Florence & Venice Grand Tour around your dates, grade level, and curriculum goals."

const sampleTab = (
  <>
    <div className="ilp-infocard">
      <h3>A detailed day-by-day sample is on the way.</h3>
      <p style={{ color: 'var(--lm-ink-muted)', fontSize: 15, lineHeight: 1.7 }}>Every Landmark trip is fully customized to your group, so we build your ideal Rome, Florence &amp; Venice Grand Tour itinerary together around your dates, grade level, and goals. Reach out and our Travel Consultants will map out the perfect schedule.</p>
...
const descriptionTab = (
  <div className="ilp-prose">
    <h2 style={{ marginTop: 0 }}>Rome, Florence &amp; Venice Grand Tour</h2>
    <p>{DESC_P1}</p>
...
export default function Itin_international__italy__rome_florence_venice_grand_tour() {
  return (
    <>
      <PageHero
        eyebrow="Italy · 10 Day / 9 Night"
        title={<>Rome, Florence &amp; Venice Grand Tour</>}
        subtitle="Italy’s three essential cities in one itinerary: history, art, and language across the whole peninsula."
        image="/images/landmark/italy-venice.webp"
        breadcrumb={[
        { label: "Destinations", href: "/destinations/" },
        { label: "International", href: "/international/" },
        { label: "Italy", href: "/international/italy/" },
        { label: "Rome, Florence & Venice Grand Tour" },
      ]}
      />
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Rome, Florence & Venice Grand Tour", path: "/international/italy/rome-florence-venice-grand-tour/" },
      ])} />
      <JsonLd data={touristTrip({
        name: "Rome, Florence & Venice Grand Tour",
        description: "Italy’s three essential cities in one itinerary: history, art, and language across the whole peninsula.",
        path: "/international/italy/rome-florence-venice-grand-tour/",
        days: [],
      })} />
    </>
  )
