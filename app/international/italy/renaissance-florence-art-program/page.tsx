...
const RELATED = [
  { title: "Classical Rome & Ancient History Tour", img: "/images/landmark/italy-rome.jpg", href: "/international/italy/classical-rome-ancient-history-tour/" },
  { title: "Rome, Florence & Venice Grand Tour", img: "/images/landmark/italy-venice.webp", href: "/international/italy/rome-florence-venice-grand-tour/" },
  { title: "Pompeii & the Bay of Naples Archaeology Trip", img: "/images/landmark/intl-italy.webp", href: "/international/italy/pompeii-naples-archaeology-trip/" },
]

const DESC_P1 = "The Uffizi, the Duomo, and the Accademia: a hands-on study of Renaissance art, humanism, and innovation. A full day-by-day sample itinerary for this program is on the way. Every Landmark trip is fully customized to your group, so our Travel Consultants will build your ideal Renaissance Florence Art & History Program around your dates, grade level, and curriculum goals."

const sampleTab = (
  <>
    <div className="ilp-infocard">
      <h3>A detailed day-by-day sample is on the way.</h3>
      <p style={{ color: 'var(--lm-ink-muted)', fontSize: 15, lineHeight: 1.7 }}>Every Landmark trip is fully customized to your group, so we build your ideal Renaissance Florence Art &amp; History Program itinerary together around your dates, grade level, and goals. Reach out and our Travel Consultants will map out the perfect schedule.</p>
...
const descriptionTab = (
  <div className="ilp-prose">
    <h2 style={{ marginTop: 0 }}>Renaissance Florence Art &amp; History Program</h2>
    <p>{DESC_P1}</p>
...
export default function Itin_international__italy__renaissance_florence_art_program() {
  return (
    <>
      <PageHero
        eyebrow="Italy · 6 Day / 5 Night"
        title={<>Renaissance Florence Art &amp; History Program</>}
        subtitle="The Uffizi, the Duomo, and the Accademia: a hands-on study of Renaissance art, humanism, and innovation."
        image="/images/landmark/italy-florence.webp"
        breadcrumb={[
        { label: "Destinations", href: "/destinations/" },
        { label: "International", href: "/international/" },
        { label: "Italy", href: "/international/italy/" },
        { label: "Renaissance Florence Art & History Program" },
      ]}
      />
        ...
        <div className="ile-container lm-itin-grid">
          ...
          <aside className="lm-itin-side">
            <div className="lm-summary-card">
              ...
              <Link href="/international/italy/" className="lm-summary-link">More Italy packages {ArrowR}</Link>
            </div>
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Renaissance Florence Art & History Program", path: "/international/italy/renaissance-florence-art-program/" },
      ])} />
      <JsonLd data={touristTrip({
        name: "Renaissance Florence Art & History Program",
        description: "The Uffizi, the Duomo, and the Accademia: a hands-on study of Renaissance art, humanism, and innovation.",
        path: "/international/italy/renaissance-florence-art-program/",
        days: [],
      })} />
    </>
  )
