...
const DESC_P1 = "Milan, Lake Como, and the Italian Lakes: art, geography, and Leonardo’s Last Supper. A full day-by-day sample itinerary for this program is on the way. Every Landmark trip is fully customized to your group, so our Travel Consultants will build your ideal Northern Italy & the Lakes Program around your dates, grade level, and curriculum goals."

const sampleTab = (
  <>
    <div className="ilp-infocard">
      <h3>A detailed day-by-day sample is on the way.</h3>
      <p style={{ color: 'var(--lm-ink-muted)', fontSize: 15, lineHeight: 1.7 }}>Every Landmark trip is fully customized to your group, so we build your ideal Northern Italy &amp; the Lakes Program itinerary together around your dates, grade level, and goals. Reach out and our Travel Consultants will map out the perfect schedule.</p>
...
const descriptionTab = (
  <div className="ilp-prose">
    <h2 style={{ marginTop: 0 }}>Northern Italy &amp; the Lakes Program</h2>
    <p>{DESC_P1}</p>
...
export default function Itin_international__italy__northern_italy_lakes_program() {
  return (
    <>
      <PageHero
        eyebrow="Italy · 8 Day / 7 Night"
        title={<>Northern Italy &amp; the Lakes Program</>}
        subtitle="Milan, Lake Como, and the Italian Lakes: art, geography, and Leonardo’s Last Supper."
        image="/images/landmark/italy-lakes.webp"
        breadcrumb={[
        { label: "Destinations", href: "/destinations/" },
        { label: "International", href: "/international/" },
        { label: "Italy", href: "/international/italy/" },
        { label: "Northern Italy & the Lakes Program" },
      ]}
      />
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Northern Italy & the Lakes Program", path: "/international/italy/northern-italy-lakes-program/" },
      ])} />
      <JsonLd data={touristTrip({
        name: "Northern Italy & the Lakes Program",
        description: "Milan, Lake Como, and the Italian Lakes: art, geography, and Leonardo’s Last Supper.",
        path: "/international/italy/northern-italy-lakes-program/",
        days: [],
      })} />
    </>
  )
