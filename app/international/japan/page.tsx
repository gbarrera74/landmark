  ...
  return (
    <div className="lm-intl">
      <PageHero
        ...
        breadcrumb={[{ label: 'Destinations', href: '/destinations/' }, { label: 'International', href: '/international/' }, { label: "Japan" }]}
      />
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "Japan", path: "/international/japan/" },
      ])} />
    </div>
  )
}
