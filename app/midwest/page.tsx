...
export default function Midwest() {
  return (
    <>
      <PageHero
        eyebrow="Destinations · Midwest"
        title={<>Midwest <em>Destinations</em></>}
        subtitle="World-class museums and Great Lakes history: customizable, safe student trips through the heart of the country."
        image="/images/landmark/chicago-hero.jpg"
        breadcrumb={[{ label: "Destinations", href: "/destinations/" }, { label: "Midwest" }]}
      />
      ...
      <section className="ile-section ile-section--cream" aria-labelledby="midwest-custom-h">
        <div className="ile-container">
          <div className="ile-center lm-narrow">
            <span className="ile-eyebrow">How it works</span>
            <h2 id="midwest-custom-h" className="lm-h2-amber">CUSTOMIZATION MADE SIMPLE</h2>
