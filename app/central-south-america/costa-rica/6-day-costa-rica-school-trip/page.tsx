...
const DAYS = [
  { title: "Day 1: Arrival & Group Sit Down Dinner", acts: ["Travel Day to Costa Rica", "Meet USA Based Tour Director & Costa Rica Tour Director!", "Meet Motorcoach and Transfer to Dinner", "Dinner: Local Restaurant", "Check-in to Hotel Accommodations"] },
  ...
  { title: "Day 5: Surfing Classes & Sarchi Visit with Workshop", acts: ["Breakfast at the hotel", "Surfing Classes", "Lunch: Local Restaurant", "Sarchi Visit with Workshop", "Dinner: Local Restaurant", "Transfer to Hotel Accommodations"] },
  { title: "Day 6: Departure", acts: ["Breakfast at the hotel", "Transfer to the Airport", "Sample Flight Departure Home"] },
]
...
const sampleTab = (
  <>
    <p className="lm-itin-note">*Customize and personalize your 6 Day Costa Rica School Trip itinerary with our team.</p>
...
const descriptionTab = (
  <div className="ilp-prose">
    <h2 style={{ marginTop: 0 }}>Explore the Ultimate 6 Day Costa Rica School Trip Itinerary</h2>
    <p>{DESC_P1}</p>
...
export default function Itin_international__costa_rica__6_day_costa_rica_school_trip() {
  return (
    <>
      <PageHero
        ...
        { label: "6 Day Costa Rica School Trip" },
      ]}
      />
      ...
      <JsonLd data={breadcrumb([
        ...
        { name: "6 Day Costa Rica School Trip", path: "/central-south-america/costa-rica/6-day-costa-rica-school-trip/" },
      ])} />
