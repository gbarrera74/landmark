    ...
    groups: [
      {
        ...
        links: [
          ...
          { label: 'Williamsburg, VA', href: '/usa-trips/williamsburg-tours/' },
          { label: 'Charleston, SC', href: '/usa-trips/charleston-sc/' },
          { label: 'Savannah, GA', href: '/usa-trips/savannah-tours/' },
      ...
      },
      {
        ...
        links: [
          ...
          { label: 'Mackinac Island, MI', href: '/usa-trips/mackinac-island-tours/' },
          { label: 'San Antonio, TX', href: '/usa-trips/san-antonio-tours/' },
          { label: 'New Mexico', href: '/usa-trips/new-mexico-tours/' },
          { label: 'Los Angeles, CA', href: '/usa-trips/los-angeles-tours/' },
